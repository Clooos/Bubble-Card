...
🌐 **[অন্য ভাষায় পড়ুন](languages.md)**
...
**[`ইনস্টলেশন`](#ইনস্টলেশন)**  **[`কনফিগারেশন`](#কনফিগারেশন)**  **[`পপ-আপ`](#পপ-আপ)**  **[`অনুভূমিক বাটন স্ট্যাক`](#অনুভূমিক-বাটন-স্ট্যাক)**  **[`বাটন`](#বাটন)**  **[`মিডিয়া প্লেয়ার`](#মিডিয়া-প্লেয়ার)**  **[`কভার`](#কভার)**  **[`সিলেক্ট`](#সিলেক্ট)**  **[`ক্লাইমেট`](#ক্লাইমেট)**  **[`ক্যালেন্ডার`](#ক্যালেন্ডার)**  **[`বিভাজক`](#বিভাজক)**  **[`খালি কলাম`](#খালি-কলাম)**  **[`শুধু সাব-বাটন`](#শুধু-সাব-বাটন)**  **[`সাব-বাটন`](#সাব-বাটন)**  **[`কার্ড লেআউট`](#কার্ড-লেআউট)**  **[`অ্যাকশন`](#ট্যাপ-ডাবল-ট্যাপ-ও-হোল্ড-অ্যাকশন)**  **[`স্টাইলিং`](#স্টাইলিং)**  **[`টেমপ্লেট`](#টেমপ্লেট)**  **[`মডিউল`](#মডিউল)**  **[`সাহায্য`](#সাহায্য)**  **[`অবদান রাখা`](#অবদান-রাখা)**  **[`অনুদান`](#অনুদান)**
...
2. ফাইলটি আপনার `<config>/www` ফোল্ডারে যোগ করুন
...
| `trigger_entity` | string | ঐচ্ছিক | যেকোনো এনটিটি | যেকোনো এনটিটির অবস্থার ভিত্তিতে এই পপ-আপ খুলুন |
| `trigger_state` | string | ঐচ্ছিক (`trigger_entity` নির্ধারিত থাকলে **আবশ্যক**) | যেকোনো এনটিটি অবস্থা | যে এনটিটি অবস্থায় পপ-আপ খুলবে |
| `trigger_close` | boolean | ঐচ্ছিক | `true` বা `false` (ডিফল্ট) | `trigger_state` ভিন্ন হলে পপ-আপ বন্ধ করুন |
...
| `slider_fill_orientation` | string | ঐচ্ছিক | `left` (ডিফল্ট), `right`, `top`, `bottom` | স্লাইডারের ভরাটের দিক পরিবর্তন করে |
| `slider_value_position` | string | ঐচ্ছিক | `right` (ডিফল্ট), `left`, `center`, `hidden` | মান প্রদর্শনের অবস্থান |
...
| `show_started_events`| boolean | ঐচ্ছিক     | `true` (ডিফল্ট) বা `false`                     | বর্তমানে চলমান ইভেন্টগুলো দেখান বা লুকান                                                 |
| `scrolling_effect`  | boolean | ঐচ্ছিক | `true` (ডিফল্ট) বা `false` | কনটেন্ট কনটেইনারের আকার ছাড়িয়ে গেলে টেক্সট স্ক্রল করতে দিন |
...
| `visibility` | object বা list | ঐচ্ছিক | দেখুন [শর্ত](https://www.home-assistant.io/docs/scripts/conditions/) | শর্তের ভিত্তিতে সাব-বাটন দেখান বা লুকান |
