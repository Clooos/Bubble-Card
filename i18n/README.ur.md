...
🌐 **[اسے کسی دوسری زبان میں پڑھیں](languages.md)**
...
**[`انسٹالیشن`](#انسٹالیشن)**  **[`کنفیگریشن`](#کنفیگریشن)**  **[`پاپ اپ`](#پاپ-اپ)**  **[`افقی بٹنوں کا اسٹیک`](#افقی-بٹنوں-کا-اسٹیک)**  **[`بٹن`](#بٹن)**  **[`میڈیا پلیئر`](#میڈیا-پلیئر)**  **[`کور`](#کور)**  **[`سلیکٹ`](#سلیکٹ)**  **[`کلائمیٹ`](#کلائمیٹ)**  **[`کیلنڈر`](#کیلنڈر)**  **[`جداکار`](#جداکار)**  **[`خالی کالم`](#خالی-کالم)**  **[`صرف ذیلی بٹن`](#صرف-ذیلی-بٹن)**  **[`ذیلی بٹن`](#ذیلی-بٹن)**  **[`کارڈ کے لے آؤٹس`](#کارڈ-کے-لے-آؤٹس)**  **[`ایکشنز`](#تھپتھپانے-دوہری-تھپتھپاہٹ-اور-دبائے-رکھنے-کے-ایکشنز)**  **[`اسٹائلنگ`](#اسٹائلنگ)**  **[`ٹیمپلیٹس`](#ٹیمپلیٹس)**  **[`ماڈیولز`](#ماڈیولز)**  **[`مدد`](#مدد)**  **[`تعاون`](#تعاون)**  **[`عطیہ`](#عطیہ)**
...
1. یہ فائل ڈاؤن لوڈ کریں: [bubble-card.js](https://raw.githubusercontent.com/Clooos/Bubble-Card/main/dist/bubble-card.js)
2. اس فائل کو اپنے `<config>/www` فولڈر میں شامل کریں
...
| `trigger_entity` | string | اختیاری | کوئی بھی entity | کسی بھی entity کی حالت کی بنیاد پر یہ پاپ اپ کھولیں |
| `trigger_state` | string | اختیاری (**لازمی** اگر `trigger_entity` متعین ہو) | کوئی بھی entity حالت | پاپ اپ کھولنے کے لیے entity کی حالت |
| `trigger_close` | boolean | اختیاری | `true` یا `false` (ڈیفالٹ) | جب `trigger_state` مختلف ہو تو پاپ اپ بند کریں |
...
| `slider_fill_orientation` | string | اختیاری | `left` (ڈیفالٹ)، `right`، `top`، `bottom` | سلائیڈر کی فل سمت تبدیل کریں |
| `slider_value_position` | string | اختیاری | `right` (ڈیفالٹ)، `left`، `center`، `hidden` | قدر ڈسپلے کی پوزیشن |
...
| `show_started_events`| boolean | اختیاری     | `true` (ڈیفالٹ) یا `false`                     | فی الحال جاری واقعات دکھائیں یا چھپائیں                                                 |
| `scrolling_effect`  | boolean | اختیاری | `true` (ڈیفالٹ) یا `false` | جب مواد کنٹینر کے سائز سے تجاوز کرے تو متن کو اسکرول ہونے دیں |
...
| `visibility` | object or list | اختیاری | دیکھیں [شرائط](https://www.home-assistant.io/docs/scripts/conditions/) | شرائط کی بنیاد پر ذیلی بٹن دکھائیں یا چھپائیں |
