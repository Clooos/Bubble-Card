...
| `trigger_close` | boolean | Ընտրովի | `true` (լռելյայն) կամ `false` | Փակում է պոպ-ապը, երբ պայմաններն այլևս չեն բավարարվում: Փոխարենը լռելյայն `false` է, երբ օգտագործում եք հին `trigger_entity` և `trigger_state` զույգը |
...
| `slider_value_position` | string | Ընտրովի | `right`, `left`, `center` կամ `hidden` | Արժեքի ցուցադրման դիրքը: Աջ կողմում, երբ սահմանված չէ, և ձախ կողմում [աջից ձախ լեզուներում](#տեղայնացում) |
...
5. (Ընտրովի) Ստեղծեք հատուկ կարգավորումների ինտերֆեյս **Editor** բաժնում (ինչպես գույնի ընտրիչը վերևի սքրինշոթում, ամբողջական փաստաթղթավորումը հասանելի է [այստեղ](https://github.com/Clooos/Bubble-Card/blob/main/src/modules/module-documentation.md)):
...
Այս փաստաթղթերը նույնպես թարգմանված են՝ [62 լեզվով](languages.md), բոլորով, բացի բրիտանական անգլերենից, որը ցույց է տալիս բնօրինակը: Այդ էջերը բաց են բոլորի համար, ուստի ձևակերպումը, որը չի համապատասխանում ձեր սեփական Home Assistant-ին, կարելի է ուղղել մի քանի սեղմումով: Անգլերեն տարբերակը մնում է հենց բովանդակության հղումը:
