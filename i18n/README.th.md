...
🌐 **[อ่านหน้านี้ในภาษาอื่น](languages.md)**
...
**[`การติดตั้ง`](#การติดตั้ง)**  **[`การกำหนดค่า`](#การกำหนดค่า)**  **[`ป๊อปอัป`](#ป๊อปอัป)**  **[`แถวปุ่มแนวนอน`](#แถวปุ่มแนวนอน)**  **[`ปุ่ม`](#ปุ่ม)**  **[`เครื่องเล่นสื่อ`](#เครื่องเล่นสื่อ)**  **[`ม่าน/ประตู`](#ม่านประตู)**  **[`เลือก`](#เลือก)**  **[`ปรับอากาศ`](#ปรับอากาศ)**  **[`ปฏิทิน`](#ปฏิทิน)**  **[`ตัวคั่น`](#ตัวคั่น)**  **[`คอลัมน์ว่าง`](#คอลัมน์ว่าง)**  **[`ปุ่มย่อยเท่านั้น`](#ปุ่มย่อยเท่านั้น)**  **[`ปุ่มย่อย`](#ปุ่มย่อย)**  **[`เลย์เอาต์การ์ด`](#เลย์เอาต์การ์ด)**  **[`การกระทำ`](#การกระทำเมื่อแตะ-แตะสองครั้ง-และกดค้าง)**  **[`การจัดสไตล์`](#การจัดสไตล์)**  **[`เทมเพลต`](#เทมเพลต)**  **[`โมดูล`](#โมดูล)**  **[`ความช่วยเหลือ`](#ความช่วยเหลือ)**  **[`การมีส่วนร่วม`](#การมีส่วนร่วม)**  **[`บริจาค`](#บริจาค)**
...
2. เพิ่มไฟล์นี้ลงในโฟลเดอร์ `<config>/www` ของคุณ
...
| `trigger_entity` | string | Optional | เอนทิตีใดก็ได้ | เปิดป๊อปอัปนี้ตามสถานะของเอนทิตีใดก็ได้ |
| `trigger_state` | string | Optional (**Required** หากกำหนด `trigger_entity`) | สถานะเอนทิตีใดก็ได้ | สถานะเอนทิตีที่ใช้เปิดป๊อปอัป |
| `trigger_close` | boolean | Optional | `true` หรือ `false` (ค่าเริ่มต้น) | ปิดป๊อปอัปเมื่อ `trigger_state` แตกต่างออกไป |
...
| `slider_fill_orientation` | string | ไม่บังคับ | `left` (ค่าเริ่มต้น), `right`, `top`, `bottom` | เปลี่ยนทิศทางการเติมเต็มของสไลเดอร์ |
| `slider_value_position` | string | ไม่บังคับ | `right` (ค่าเริ่มต้น), `left`, `center`, `hidden` | ตำแหน่งของการแสดงค่า |
...
| `show_started_events`| boolean | ไม่บังคับ     | `true` (ค่าเริ่มต้น) หรือ `false`                     | แสดงหรือซ่อนกิจกรรมที่กำลังดำเนินอยู่                                                 |
| `scrolling_effect`  | boolean | ไม่บังคับ | `true` (ค่าเริ่มต้น) หรือ `false` | ให้ข้อความเลื่อนได้เมื่อเนื้อหาเกินขนาดของคอนเทนเนอร์ |
...
| `visibility` | object หรือ list | ไม่บังคับ | ดู [เงื่อนไข](https://www.home-assistant.io/docs/scripts/conditions/) | แสดงหรือซ่อนปุ่มย่อยตามเงื่อนไข |
