...
🌐 **[இதை வேறொரு மொழியில் படிக்கவும்](languages.md)**
...
**[`நிறுவல்`](#நிறுவல்)**  **[`உள்ளமைவு`](#உள்ளமைவு)**  **[`பாப்-அப்`](#பாப்-அப்)**  **[`கிடைமட்ட பட்டன் அடுக்கு`](#கிடைமட்ட-பட்டன்-அடுக்கு)**  **[`பட்டன்`](#பட்டன்)**  **[`மீடியா பிளேயர்`](#மீடியா-பிளேயர்)**  **[`மறைப்பு`](#மறைப்பு)**  **[`தேர்வு`](#தேர்வு)**  **[`காலநிலை`](#காலநிலை)**  **[`காலெண்டர்`](#காலெண்டர்)**  **[`பிரிப்பான்`](#பிரிப்பான்)**  **[`வெற்று நெடுவரிசை`](#வெற்று-நெடுவரிசை)**  **[`துணை பட்டன்கள் மட்டும்`](#துணை-பட்டன்கள்-மட்டும்)**  **[`துணை பட்டன்கள்`](#துணை-பட்டன்கள்)**  **[`கார்டு தளவமைப்புகள்`](#கார்டு-தளவமைப்புகள்)**  **[`செயல்கள்`](#தட்டு-இரட்டைத்-தட்டு-மற்றும்-அழுத்திப்-பிடி-செயல்கள்)**  **[`வடிவமைப்பு`](#வடிவமைப்பு)**  **[`டெம்ப்ளேட்கள்`](#டெம்ப்ளேட்கள்)**  **[`மாட்யூல்கள்`](#மாட்யூல்கள்)**  **[`உதவி`](#உதவி)**  **[`பங்களிப்பு`](#பங்களிப்பு)**  **[`நன்கொடை`](#நன்கொடை)**
...
1. இந்த கோப்பை பதிவிறக்கவும்: [bubble-card.js](https://raw.githubusercontent.com/Clooos/Bubble-Card/main/dist/bubble-card.js)
2. இந்த கோப்பை உங்கள் `<config>/www` கோப்புறையில் சேர்க்கவும்
...
| `trigger_entity` | string | விருப்பத்தேர்வு | எந்த entity-யும் | எந்த entity-யின் நிலையின் அடிப்படையிலும் இந்த பாப்-அப்பைத் திறக்கிறது |
...
| `trigger_close` | boolean | விருப்பத்தேர்வு | `true` அல்லது `false` (இயல்பு) | `trigger_state` வேறுபட்டிருக்கும்போது பாப்-அப்பை மூடுகிறது |
...
| `slider_fill_orientation` | string | Optional | `left` (default), `right`, `top`, `bottom` | Slider-இன் நிரப்பு திசையை மாற்றவும் |
| `slider_value_position` | string | Optional | `right` (default), `left`, `center`, `hidden` | மதிப்பு காட்சியின் நிலை |
...
| `show_started_events`| boolean | Optional     | `true` (default) or `false`                     | தற்போது நடைபெற்றுக் கொண்டிருக்கும் நிகழ்வுகளைக் காட்டவும் அல்லது மறைக்கவும்                                                 |
| `scrolling_effect`  | boolean | Optional | `true` (default) or `false` | உள்ளடக்கம் அதன் கொள்கலனின் அளவை மீறும்போது உரை ஸ்க்ரோல் ஆக அனுமதிக்கவும் |
...
| `visibility` | object அல்லது list | விருப்பத்தேர்வு | பார்க்க [நிபந்தனைகள்](https://www.home-assistant.io/docs/scripts/conditions/) | நிபந்தனைகளின் அடிப்படையில் துணை பட்டனைக் காட்டவும் அல்லது மறைக்கவும் |
...
ஆனால் இந்த அம்சம் அதைவிட மிகவும் சக்திவாய்ந்தது, இது Home Assistant-இன் இயல்புநிலை [படிவ](https://github.com/Clooos/Bubble-Card/blob/main/src/modules/editor-schema-docs.md) விருப்பங்கள் அனைத்தையும் பயன்படுத்தி, Bubble Card எடிட்டரில் நீங்களே உண்மையான அம்சங்களைச் சேர்க்க அனுமதிக்கிறது!  
...
5. (விருப்பம்) **Editor** பிரிவில் ஒரு தனிப்பயன் உள்ளமைவு UI-ஐ உருவாக்கவும் (மேலே உள்ள ஸ்கிரீன்ஷாட்டில் உள்ள கலர் பிக்கர் போன்று, முழு ஆவணமும் [இங்கே](https://github.com/Clooos/Bubble-Card/blob/main/src/modules/editor-schema-docs.md) கிடைக்கும்).
6. **Save** என்பதைக் கிளிக் செய்யவும்.
