...
| `trigger_close` | boolean | விருப்பத்தேர்வு | `true` அல்லது `false` | நிபந்தனைகள் இனி பூர்த்தியாகாதபோது பாப்-அப்பை மூடுகிறது (இயல்பு: `trigger` உடன் `true`, `trigger_state` உடன் `false`) |
...
| `slider_value_position` | string | Optional | `right`, `left`, `center` அல்லது `hidden` | மதிப்பு காட்சியின் நிலை. வரையறுக்கப்படாதபோது முடிவுப் பக்கத்தில், எனவே [வலமிருந்து இடமாக எழுதப்படும் மொழிகளில்](#உள்ளூராக்கம்) இடதுபுறம் |
...
இந்த ஆவணமும் மொழிபெயர்க்கப்பட்டுள்ளது, [62 மொழிகளில்](languages.md). அந்தப் பக்கங்கள் அனைவருக்கும் திறந்திருக்கின்றன, எனவே உங்கள் சொந்த Home Assistant உடன் பொருந்தாத ஒரு சொல்லாடலைச் சில கிளிக்குகளில் திருத்தலாம். உள்ளடக்கத்திற்கான குறிப்பு ஆவணமாக ஆங்கிலப் பதிப்பே இருக்கும்.
