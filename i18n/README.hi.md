...
🌐 **[इसे किसी अन्य भाषा में पढ़ें](languages.md)**
...
**[`इंस्टॉलेशन`](#इंस्टॉलेशन)**  **[`कॉन्फ़िगरेशन`](#कॉन्फ़िगरेशन)**  **[`पॉप-अप`](#पॉप-अप)**  **[`हॉरिज़ॉन्टल बटन स्टैक`](#हॉरिज़ॉन्टल-बटन-स्टैक)**  **[`बटन`](#बटन)**  **[`मीडिया प्लेयर`](#मीडिया-प्लेयर)**  **[`कवर`](#कवर)**  **[`सेलेक्ट`](#सेलेक्ट)**  **[`क्लाइमेट`](#क्लाइमेट)**  **[`कैलेंडर`](#कैलेंडर)**  **[`सेपरेटर`](#सेपरेटर)**  **[`खाली कॉलम`](#खाली-कॉलम)**  **[`केवल सब-बटन`](#केवल-सब-बटन)**  **[`सब-बटन`](#सब-बटन)**  **[`कार्ड लेआउट`](#कार्ड-लेआउट)**  **[`एक्शन`](#टैप-डबल-टैप-और-होल्ड-एक्शन)**  **[`स्टाइलिंग`](#स्टाइलिंग)**  **[`टेम्पलेट`](#टेम्पलेट)**  **[`मॉड्यूल`](#मॉड्यूल)**  **[`सहायता`](#सहायता)**  **[`योगदान`](#योगदान)**  **[`दान करें`](#दान-करें)**
...
2. इस फ़ाइल को अपने `<config>/www` फ़ोल्डर में जोड़ें
...
| `trigger_entity` | string | वैकल्पिक | कोई भी एंटिटी | किसी भी एंटिटी की स्थिति के आधार पर इस पॉप-अप को खोलें |
...
| `trigger_close` | boolean | वैकल्पिक | `true` या `false` (डिफ़ॉल्ट) | जब `trigger_state` अलग हो तो पॉप-अप बंद करें |
...
| `slider_fill_orientation` | string | वैकल्पिक | `left` (डिफ़ॉल्ट), `right`, `top`, `bottom` | स्लाइडर की फिल दिशा बदलें |
| `slider_value_position` | string | वैकल्पिक | `right` (डिफ़ॉल्ट), `left`, `center`, `hidden` | वैल्यू डिस्प्ले की पोज़िशन |
...
| `show_started_events`| boolean | वैकल्पिक     | `true` (डिफ़ॉल्ट) या `false`                     | अभी चल रहे इवेंट दिखाएं या छिपाएं                                                 |
| `scrolling_effect`  | boolean | वैकल्पिक | `true` (डिफ़ॉल्ट) या `false` | जब कंटेंट उसके कंटेनर के आकार से बड़ा हो तो टेक्स्ट को स्क्रॉल होने दें |
...
| `visibility` | object या list | वैकल्पिक | देखें [शर्तें](https://www.home-assistant.io/docs/scripts/conditions/) | शर्तों के आधार पर सब-बटन दिखाएं या छिपाएं |
