...
1. [नवीनतम रिलीज़](https://github.com/Clooos/Bubble-Card/releases/latest) से `bubble-card.zip` डाउनलोड करें
2. इसे अपने `<config>/www` फ़ोल्डर में एक्सट्रैक्ट करें, आपको `bubble-card.js` और उसके बगल में एक `translations` फ़ोल्डर मिलना चाहिए (उस फ़ोल्डर में एडिटर की डिक्शनरी होती हैं, उसके बिना एडिटर अंग्रेज़ी में ही रहता है)
...
| `trigger_close` | boolean | वैकल्पिक | `true` या `false` | शर्तें पूरी न रहने पर पॉप-अप बंद करता है (डिफ़ॉल्ट: `trigger` के साथ `true`, `trigger_state` के साथ `false`) |
...
| `slider_value_position` | string | वैकल्पिक | `right`, `left`, `center` या `hidden` | मान के प्रदर्शन की स्थिति। परिभाषित न होने पर अंत वाली ओर, यानी [दाएँ से बाएँ लिखी जाने वाली भाषाओं](#स्थानीयकरण) में बाईं ओर |
...
| `--bubble-sub-button-outline` | `box-shadow` | किसी सब-बटन या स्लाइडर पर तभी जोड़ी जाने वाली आउटलाइन जब वह अपने पीछे के कार्ड जैसा ही रंग लेता है, जिससे वह अदृश्य हो जाता (हटाने के लिए इसे `none` पर सेट करें) |
...
लेकिन यह फीचर उससे कहीं अधिक शक्तिशाली है, यह आपको Bubble Card एडिटर में, सभी डिफ़ॉल्ट [Home Assistant फॉर्म](https://github.com/Clooos/Bubble-Card/blob/main/src/modules/editor-schema-docs.md) विकल्पों का उपयोग करके, खुद असली फीचर जोड़ने देता है!  
ऑब्जेक्ट सिलेक्टर को लाइव बदलाव दिखाने और एट्रिब्यूट को सही ढंग से सपोर्ट करने के लिए बेहतर बनाया गया है।

कोई मॉड्यूल अंतर्निहित [एंटिटी सुझावों](#एंटिटी-सुझाव) के साथ Home Assistant के कार्ड पिकर को भी जवाब दे सकता है: जिन कार्ड का वर्णन पहले से किया जा सकता है उनके लिए `suggestions` का उपयोग करें, और जब उन्हें आपके सेटअप से गणना करनी हो तब `suggestions_code` का, उदाहरण के लिए चुनी गई एंटिटी जिस एरिया की है उसकी हर एंटिटी से बना एक पॉप-अप। दोनों कुंजियों का दस्तावेज़ीकरण [यहाँ](https://github.com/Clooos/Bubble-Card/blob/main/src/modules/editor-schema-docs.md#entity-suggestions) है।
...
5. (वैकल्पिक) **Editor** सेक्शन में एक कस्टम कॉन्फ़िगरेशन UI बनाएं (जैसे ऊपर स्क्रीनशॉट में कलर पिकर, पूरा दस्तावेज़ीकरण [यहाँ](https://github.com/Clooos/Bubble-Card/blob/main/src/modules/editor-schema-docs.md) उपलब्ध है)।
...
यह दस्तावेज़ीकरण भी अनुवादित है, [62 भाषाओं में](languages.md)। ये पेज सभी के लिए खुले हैं, इसलिए जो शब्द आपके अपने Home Assistant से मेल नहीं खाता उसे कुछ ही क्लिक में ठीक किया जा सकता है। सामग्री के लिए अंग्रेज़ी संस्करण ही संदर्भ बना रहता है।
