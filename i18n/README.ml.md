...
🌐 **[ഇത് മറ്റൊരു ഭാഷയിൽ വായിക്കുക](languages.md)**
...
**[`ഇൻസ്റ്റാളേഷൻ`](#ഇൻസ്റ്റാളേഷൻ)**  **[`കോൺഫിഗറേഷൻ`](#കോൺഫിഗറേഷൻ)**  **[`പോപ്പ്-അപ്പ്`](#പോപ്പ്-അപ്പ്)**  **[`തിരശ്ചീന ബട്ടൺ സ്റ്റാക്ക്`](#തിരശ്ചീന-ബട്ടൺ-സ്റ്റാക്ക്)**  **[`ബട്ടൺ`](#ബട്ടൺ)**  **[`മീഡിയ പ്ലെയർ`](#മീഡിയ-പ്ലെയർ)**  **[`കവർ`](#കവർ)**  **[`സെലക്റ്റ്`](#സെലക്റ്റ്)**  **[`കാലാവസ്ഥാ നിയന്ത്രണം`](#കാലാവസ്ഥാ-നിയന്ത്രണം)**  **[`കലണ്ടർ`](#കലണ്ടർ)**  **[`വിഭജനി`](#വിഭജനി)**  **[`ഒഴിഞ്ഞ കോളം`](#ഒഴിഞ്ഞ-കോളം)**  **[`സബ്-ബട്ടണുകൾ മാത്രം`](#സബ്-ബട്ടണുകൾ-മാത്രം)**  **[`സബ്-ബട്ടണുകൾ`](#സബ്-ബട്ടണുകൾ)**  **[`കാർഡ് ലേഔട്ടുകൾ`](#കാർഡ്-ലേഔട്ടുകൾ)**  **[`ടാപ്പ്, ഇരട്ട ടാപ്പ്, അമർത്തിപ്പിടിക്കൽ പ്രവർത്തനങ്ങൾ`](#ടാപ്പ്-ഇരട്ട-ടാപ്പ്-അമർത്തിപ്പിടിക്കൽ-പ്രവർത്തനങ്ങൾ)**  **[`സ്റ്റൈലിംഗ്`](#സ്റ്റൈലിംഗ്)**  **[`ടെംപ്ലേറ്റുകൾ`](#ടെംപ്ലേറ്റുകൾ)**  **[`മൊഡ്യൂളുകൾ`](#മൊഡ്യൂളുകൾ)**  **[`സഹായം`](#സഹായം)**  **[`സംഭാവന ചെയ്യൽ`](#സംഭാവന-ചെയ്യൽ)**  **[`സാമ്പത്തിക പിന്തുണ`](#സാമ്പത്തിക-പിന്തുണ)**
...
1. ഈ ഫയൽ ഡൗൺലോഡ് ചെയ്യുക: [bubble-card.js](https://raw.githubusercontent.com/Clooos/Bubble-Card/main/dist/bubble-card.js)
2. ഈ ഫയൽ നിങ്ങളുടെ `<config>/www` ഫോൾഡറിലേക്ക് ചേർക്കുക
...
| `trigger_entity` | string | ഓപ്ഷണൽ | ഏതെങ്കിലും എന്റിറ്റി | ഏതെങ്കിലും എന്റിറ്റിയുടെ അവസ്ഥയെ അടിസ്ഥാനമാക്കി ഈ പോപ്പ്-അപ്പ് തുറക്കുക |
...
| `trigger_close` | boolean | ഓപ്ഷണൽ | `true` അല്ലെങ്കിൽ `false` (സ്വതവേ) | `trigger_state` വ്യത്യസ്തമാകുമ്പോൾ പോപ്പ്-അപ്പ് അടയ്ക്കുക |
...
| `slider_fill_orientation` | string | Optional | `left` (default), `right`, `top`, `bottom` | സ്ലൈഡറിന്റെ ഫിൽ ദിശ മാറ്റുക |
| `slider_value_position` | string | Optional | `right` (default), `left`, `center`, `hidden` | മൂല്യ പ്രദർശനത്തിന്റെ സ്ഥാനം |
...
| `show_started_events`| boolean | Optional     | `true` (default) or `false`                     | നിലവിൽ നടന്നുകൊണ്ടിരിക്കുന്ന ഇവന്റുകൾ കാണിക്കുക അല്ലെങ്കിൽ മറയ്ക്കുക                                                 |
| `scrolling_effect`  | boolean | Optional | `true` (default) or `false` | ഉള്ളടക്കം കണ്ടെയ്നറിന്റെ വലുപ്പം കവിയുമ്പോൾ ടെക്സ്റ്റ് സ്ക്രോൾ ചെയ്യാൻ അനുവദിക്കുക |
...
| `visibility` | object അല്ലെങ്കിൽ list | ഐച്ഛികം | [conditions](https://www.home-assistant.io/docs/scripts/conditions/) കാണുക | നിബന്ധനകളുടെ അടിസ്ഥാനത്തിൽ സബ്-ബട്ടൺ കാണിക്കുകയോ ഒളിപ്പിക്കുകയോ ചെയ്യുക |
...
പക്ഷേ ഈ ഫീച്ചർ അതിനേക്കാൾ വളരെ ശക്തമാണ്, Home Assistant യുടെ എല്ലാ ഡിഫോൾട്ട് [ഫോം](https://github.com/Clooos/Bubble-Card/blob/main/src/modules/editor-schema-docs.md) ഓപ്ഷനുകൾ ഉപയോഗിച്ച്, Bubble Card എഡിറ്ററിൽ യഥാർത്ഥ ഫീച്ചറുകൾ നിങ്ങൾക്ക് സ്വയം ചേർക്കാൻ ഇത് അനുവദിക്കുന്നു!  
...
5. (ഓപ്ഷണൽ) **Editor** സെക്ഷനിൽ ഒരു കസ്റ്റം കോൺഫിഗറേഷൻ UI സൃഷ്ടിക്കുക (മുകളിലെ സ്ക്രീൻഷോട്ടിലെ കളർ പിക്കർ പോലെ, [ഇവിടെ](https://github.com/Clooos/Bubble-Card/blob/main/src/modules/editor-schema-docs.md) പൂർണ്ണ ഡോക്യുമെന്റേഷൻ ലഭ്യമാണ്).
6. **Save** ക്ലിക്ക് ചെയ്യുക.
