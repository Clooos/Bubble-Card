...
| `trigger_close` | boolean | ഓപ്ഷണൽ | `true` അല്ലെങ്കിൽ `false` | വ്യവസ്ഥകൾ പാലിക്കപ്പെടാതാകുമ്പോൾ പോപ്പ്-അപ്പ് അടയ്ക്കുക (സ്വതവേ: `trigger` നൊപ്പം `true`, `trigger_state` നൊപ്പം `false`) |
...
| `slider_value_position` | string | Optional | `right`, `left`, `center` അല്ലെങ്കിൽ `hidden` | മൂല്യ പ്രദർശനത്തിന്റെ സ്ഥാനം. നിർവചിച്ചില്ലെങ്കിൽ അവസാന ഭാഗത്ത്, അതായത് [വലത്തുനിന്ന് ഇടത്തോട്ടുള്ള ഭാഷകളിൽ](#പ്രാദേശികവൽക്കരണം) ഇടത്ത് |
...
| `--bubble-sub-button-outline` | `box-shadow` | ഒരു സബ്-ബട്ടണോ സ്ലൈഡറോ അതിനു പിന്നിലെ കാർഡിന്റെ അതേ നിറത്തിൽ വരയ്ക്കപ്പെട്ട്, അതു കാണാതാകുമ്പോൾ മാത്രം ചേർക്കുന്ന ഔട്ട്‌ലൈൻ (നീക്കം ചെയ്യാൻ `none` ആയി സജ്ജമാക്കുക) |
...
ഈ ഡോക്യുമെന്റേഷനും വിവർത്തനം ചെയ്തിട്ടുണ്ട്, [62 ഭാഷകളിൽ](languages.md). ആ പേജുകൾ എല്ലാവർക്കുമായി തുറന്നിരിക്കുന്നു, അതിനാൽ നിങ്ങളുടെ സ്വന്തം Home Assistant മായി പൊരുത്തപ്പെടാത്ത ഒരു പ്രയോഗം ഏതാനും ക്ലിക്കുകളിൽ തിരുത്താം. ഉള്ളടക്കത്തിന്റെ അടിസ്ഥാനം ഇംഗ്ലീഷ് പതിപ്പ് തന്നെയാണ്.
