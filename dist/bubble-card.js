        ...
        `}makeDropdown(e,t,n,o,i){if(e.includes("icon")||e.includes("Icon"))return _e.qy`
          ...
          `}makeTextField(e,t,n={}){const{type:o="text",disabled:i,min:a,max:r,step:s,inputMode:l,placeholder:c}=n,d={text:{}};return"number"===o&&(d.text={type:"number"}),_e.qy`
            <ha-form
                ...
                @value-changed=${e=>{const n=e.detail.value[t];this._valueChanged({target:{configValue:t},detail:{value:n}})}}
            ></ha-form>
        `}_renderConditionalContent(e,t){return e?t:_e.qy``}_renderNestedStandalonePopupWarning(){return _e.qy`
            <div class="bubble-info warning">
                <h4 class="bubble-section-title">
                    <ha-icon icon="mdi:alert-outline"></ha-icon>
