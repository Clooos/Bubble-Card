          ...
          `}>
            <div class="code-editor-container">
              <ha-code-editor
                ...
                @value-changed=${n=>(n=>{if(!e._editingModule||!e._config||t)return;const o=e._editingModule.id;if(!e._originalModuleState){const t=style_processor.Ki.get(o);t&&(e._originalModuleState=JSON.parse(JSON.stringify(t)))}e._editingModule.code=n,e.stylesYAML&&(e.stylesYAML=null);const a={...style_processor.Ki.get(o)||{},code:n,id:o};style_processor.Ki.set(o,a),updateModuleInConfig(e,o,e._previousModuleId),refreshStyles(e),broadcastModuleUpdate(o,a)})(n.detail.value)}
              ></ha-code-editor>
            </div>
  ...
  - trigger:
    ...
    sensor:
      - name: "Bubble Card Modules"
        ...
        ${(()=>{const o=isSlTabGroupAvailable(),a=e._selectedModuleTab||0;return o?x`
        <sl-tab-group 
          id="${t}"
          .selected=${a.toString()}
          @sl-tab-show=${i}>
      ...
      `})()}
        ...
        ${0===e._selectedModuleTab?x`
          ...
          ${e._showNewModuleForm||e._editingModule?renderModuleEditorForm(e):x`
            ...
            ${Array.from(style_processor.Ki.keys()).sort(((e,t)=>"default"===e?-1:"default"===t?1:0)).map((t=>{const{name:i,description:r,formSchema:s,supportedCards:l,unsupportedCard:c,creator:d,moduleLink:u,moduleVersion:p}=(0,modules_utils.a7)(t),h=e._config.modules?.includes(t),b=e._config[t];void 0===e._workingModuleConfigs[t]&&(e._workingModuleConfigs[t]=structuredClone(b??{}));const m=e._workingModuleConfigs[t],g=e._config.card_type??"";let f=!1;f=l&&Array.isArray(l)&&l.length>0?!l.includes(g):c.includes(g);const _=s&&s.length>0?e._getProcessedSchema(t,s,b):[],y=o.modules.some((e=>e.id===t))&&n,v=y?o.modules.find((e=>e.id===t)):null;return x`
                <ha-expansion-panel 
                  outlined 
                  class="${f?"disabled":""}"
                    ...
                    ${getLazyLoadedPanelContent(e,t,!!e._expandedPanelStates[t],(()=>x`
                      ...
                      ${s.length>0?x`
                          ...
                          <ha-form
                            ...
                            .computeLabel=${e._computeLabelCallback}
                            .disabled=${!h}
                            @value-changed=${n=>e._valueChangedInHaForm(n,t,s)}
                          ></ha-form>
                          <hr>
                        `:""}
