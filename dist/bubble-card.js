...
template:
  - trigger:
    ...
    <div class="module-store">
            ...
            <div class="store-module-card">
              ...
              <div class="store-module-content">
                <div class="store-module-description">
                  ${t.description?ee`
                    <p class="module-description" .innerHTML=${(0,ze.bx)(t.description)}></p>
                  `:ee`
      ...
      <div class="back-to-top-button" @click=${()=>(0,ze.XY)(e)}>
...
template:
  ...
  `}(e):ee`
          ...
          <div class="module-editor-buttons-container" style="display: flex;">
            <button class="icon-button" style="flex: 1;" @click=${()=>{e._showNewModuleForm=!0,e._showManualImportForm=!1,e._generateUniqueModuleId&&(e._newModuleTemplate.id=e._generateUniqueModuleId("my_module")),e._editingModule={...e._newModuleTemplate},e._config.modules||(e._config.modules=e._config.style_templates||[]),e._config.modules.includes(e._editingModule.id)||(e._config.modules=[...e._config.modules,e._editingModule.id],(0,c.rC)(e,"config-changed",{config:e._config})),e.requestUpdate(),setTimeout((()=>(0,ze.XY)(e)),0)}}>
              <ha-icon icon="mdi:puzzle-plus"></ha-icon>
              Create new Module
            </button>
            
            <button class="icon-button" style="flex: 1;" @click=${()=>{e._showManualImportForm=!0,e._showNewModuleForm=!1,e._manualYamlContent="",e.requestUpdate(),setTimeout((()=>(0,ze.XY)(e)),0)}}>
