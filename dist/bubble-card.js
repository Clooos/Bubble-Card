      ...
      - name: "Bubble Card Modules"
        ...
        ${0===e._selectedModuleTab?x`
          ...
          ${e._showNewModuleForm||e._editingModule?renderModuleEditorForm(e):x`
            ...
            ${Array.from(style_processor.Ki.keys()).sort(((e,t)=>"default"===e?-1:"default"===t?1:0)).map((t=>{const{name:a,description:i,formSchema:r,supportedCards:s,unsupportedCard:l,creator:c,moduleLink:d,moduleVersion:u}=(0,modules_utils.a7)(t),p=e._config.modules?.includes(t),h=e._config.card_type??"";let b=!1;b=s&&Array.isArray(s)&&s.length>0?!s.includes(h):l.includes(h);const m=e._config[t],g=r&&r.length>0?e._getProcessedSchema(t,r,m):[],f=n.modules.some((e=>e.id===t)),_=f?n.modules.find((e=>e.id===t)):null;return x`
                <ha-expansion-panel outlined class="${b?"disabled":""}">
                  <h4 slot="header">
                    <ha-icon
          ...
          <hr>
          ${e._showNewModuleForm||e._editingModule?"":x`
