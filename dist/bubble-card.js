  ...
  - trigger:
    ...
    <div class="module-store">
      ...
      <div class="store-modules">
        ${We(e).map(t=>{const n=Ke(t.id),o=Ge(t.id),i=Je(t.id,t.version),a=e._config.card_type??"";let r=!0;return r=t.supportedCards&&Array.isArray(t.supportedCards)&&t.supportedCards.length>0?t.supportedCards.includes(a):!t.unsupportedCards||!t.unsupportedCards.includes(a),ee`
              ...
              <div class="store-module-header ${r?"":"warning"}">
                ...
                <div class="store-module-meta">
                  ...
                  <div class="version-container">
                    ${Xe(t)?ee`<span class="bubble-badge new-badge"><ha-icon icon="mdi:bell-outline"></ha-icon> New</span>`:""}
  ...
  - trigger:
    ...
    sensor:
      - name: "Bubble Card Modules"
        ...
        ${(()=>{const n=dt(),i=e._selectedModuleTab||0,r=ct[i]??i.toString(),s=t=>{const n=ct.indexOf(t);e._selectedModuleTab=-1!==n?n:parseInt(t,10)||0,e.requestUpdate(),requestAnimationFrame(()=>(0,je.XY)(e,!1))};return"ha-tab-group"===n?ee`
        <ha-tab-group
          id="${t}"
          .activePanel=${r}
          @wa-tab-show=${a}
              ...
              <div class="card-content">
                ...
                <div style="display: flex; gap: 8px; justify-content: flex-end;">
                  ...
                  <button 
                    class="icon-button" 
                    style="flex: 1;"
                    @click=${async()=>{try{const t=e._manualYamlContent;if(!t||""===t.trim())return void(0,c.rC)(e,"bubble-card-error",{message:"No YAML content provided"});await qe(e,t),e._showManualImportForm=!1,e._manualYamlContent="",e.requestUpdate()}catch(e){console.error("Error installing manual module:",e)}}}
                  >
            ...
            <div class="content">
                <div class="export-section">
                    <div class="export-buttons">
                        ...
                        <button class="icon-button" @click=${()=>{!function(e,t,n){try{const o=tt(t),i=new Blob([o],{type:"text/yaml"}),a=URL.createObjectURL(i),r=document.createElement("a");return r.href=a,r.download=`${t.id}.yaml`,document.body.appendChild(r),r.click(),document.body.removeChild(r),URL.revokeObjectURL(a),(0,Ne.q)(e,"Module downloaded as YAML file!","success"),"function"==typeof n&&n(o),!0}catch(t){return console.error("Error downloading module:",t),(0,Ne.q)(e,"Error downloading module: "+t.message,"error"),!1}}(e,e._editingModule,a)}}>
            ...
            ${Array.from(s.Ki.keys()).sort((e,t)=>"default"===e?-1:"default"===t?1:0).map(t=>{const{name:n,description:a,formSchema:r,supportedCards:l,unsupportedCard:d,creator:u,moduleLink:p,moduleVersion:h}=(0,je.a7)(t),b=function(e,t){const n=e._config?.modules||[],o=Array.isArray(n)?n:[n];return!o.includes(`!${t}`)&&(!!o.includes(t)||ht(t,e.hass))}(e,t),m=ht(t,e.hass),g=r&&r.length>0,f="default"===t,v=f||g,y=e._config[t];void 0===e._workingModuleConfigs[t]&&(e._workingModuleConfigs[t]=structuredClone(y??{}));const _=e._workingModuleConfigs[t],w=e._config.card_type??"";let x=!1;x=l&&Array.isArray(l)&&l.length>0?!l.includes(w):d.includes(w);const k=r&&r.length>0?e._getProcessedSchema(t,r,y):[],C=i.modules.some(e=>e.id===t)&&o,$=C?i.modules.find(e=>e.id===t):null;return ee`
                ...
                >
                  ...
                  <div class="content" style="margin-top: 4px;">
                    ${De(e,t,!!e._expandedPanelStates[t],()=>ee`
                        ...
                        <div class="module-toggles-container">
                          ...
                          <div class="module-toggles">
                            <button 
                              ...
                              @click=${()=>{(t=>{const n=t.target,o=n.configValue,i=n.checked;e._config.modules=Array.isArray(e._config.modules)?e._config.modules:[];const a=ht(o,e.hass);i?(e._config.modules=e._config.modules.filter(e=>e!==`!${o}`),a||e._config.modules.includes(o)||(e._config.modules=[...e._config.modules,o])):a?(e._config.modules.includes(`!${o}`)||(e._config.modules=[...e._config.modules,`!${o}`]),e._config.modules=e._config.modules.filter(e=>e!==o)):e._config.modules=e._config.modules.filter(e=>e!==o),(0,c.rC)(e,"config-changed",{config:e._config}),e.requestUpdate()})({target:{checked:!b,configValue:t}})}}
                            >
                            ...
                            ${o?ee`
                              <button 
                                ...
                                @click=${()=>{v||(async(t,n)=>{await pt(e,t,n)&&(!0===n&&(e._config.modules=Array.isArray(e._config.modules)?e._config.modules.filter(e=>e!==`!${t}`):[]),(0,c.rC)(e,"config-changed",{config:e._config}),e.requestUpdate(),setTimeout(()=>e.requestUpdate(),100))})(t,!m)}}
                                ?disabled=${v}
                              >
    ...
    `}(this);case void 0:return ee`
        ...
        `}makeDropdown(e,t,n,o){if(e.includes("icon")||e.includes("Icon"))return ee`
          ...
          `}_renderConditionalContent(e,t){return e?t:ee``}makeActionPanel(e,t=this._config,n,o,i=this._config){const a="Tap action"===e?"mdi:gesture-tap":"Double tap action"===e?"mdi:gesture-double-tap":"Hold action"===e?"mdi:gesture-tap-hold":"mdi:gesture-tap",r="Tap action"===e?"tap_action":"Double tap action"===e?"double_tap_action":"Hold action"===e?"hold_action":"Open action"===e?"open_action":"close_action",s=o?`action_panel_${o}_${i}_${r}`:`action_panel_config_${r}`;let l;try{l="Tap action"===e?t.tap_action:"Double tap action"===e?t.double_tap_action:"Hold action"===e?t.hold_action:"Open action"===e?t.open_action:t.close_action}catch{}const c=t===this._config;return n||(n=c&&"Tap action"===e?"name"!==this._config.button_type?"more-info":"none":c?"none":""),ee`
            ...
            >
                ...
                <div class="content"> 
                    ${De(this,s,!!this._expandedPanelStates[s],()=>ee`
                        <ha-form
                            .hass=${this.hass}
                            .data=${t}
        ...
        `}makeSubButtonPanel(){return function(e){void 0===e._expandedPanelStates&&(e._expandedPanelStates={});const t=e._config?.sub_button?.map((t,n)=>{if(!t)return;const o="sub_button."+n+".",i=t.entity??e._config.entity,a=i?.startsWith("input_select")||i?.startsWith("select")||t.select_attribute,r=e.hass.states[i]?.attributes,s=e._selectable_attributes.some(e=>r?.[e]),l=Object.keys(e.hass.states[i]?.attributes||{}).map(t=>{let n=e.hass.states[i];return{label:e.hass.formatEntityAttributeName(n,t),value:t}}).filter(t=>e._selectable_attributes.includes(t.value)),c=t.visibility??[],d=`sub_button_main_${n}`,u=`sub_button_settings_${n}`,p=`sub_button_actions_${n}`,h=`sub_button_visibility_${n}`;return ee`
            ...
            >
                ...
                <div class="content">
                    ${De(e,d,!!e._expandedPanelStates[d],()=>ee`
                        <ha-expansion-panel 
                            outlined
                        ...
                        >
                            ...
                            <div class="content">
                                ${De(e,u,!!e._expandedPanelStates[u],()=>ee` 
                                    <ha-form
                                        .hass=${e.hass}
                                        .data=${t}
                        ...
                        >
                            ...
                            <div class="content">
                                ${De(e,p,!!e._expandedPanelStates[p],()=>ee`
                        ...
                        >
                            ...
                            <div class="content">
                                ${De(e,h,!!e._expandedPanelStates[h],()=>ee`
    ...
    `}(this)}makeVersion(){return ee`
        ...
        `}makeStyleEditor(){const e="style_editor_panel";return ee`
            ...
            >
                ...
                <div class="content">
                    ${De(this,e,!!this._expandedPanelStates[e],()=>ee`
