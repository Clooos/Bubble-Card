            ...
            <div class="content">
                ...
                <ha-formfield>
                    <ha-switch
                        ...
                        .disabled=${e._config.relative_slide||isReadOnlyEntity(e)}
                    ></ha-switch>
                ...
                <ha-formfield>
                    <ha-switch
                        ...
                        @change="${e._valueChanged}"
                        .disabled=${e._config.tap_to_slide||isReadOnlyEntity(e)}
                    ></ha-switch>
                    <div class="mdc-form-field">
...
template:
  - trigger:
    ...
    `;if(!e._storeModules){const t=(0,cache.getCachedModuleData)();if(t){e._storeModules=t.modules,e._isLoadingStore=!1;const n=Date.now(),o=n-(t.lastFetchedAt||(t.expiration?t.expiration-864e5:0))>216e5,a=t.expiration<n+36e5;(o||a)&&_fetchModuleStore(e,!0)}else e._isLoadingStore=!0,_fetchModuleStore(e)}if(e._storeAutoRefreshTimer||(e._storeAutoRefreshTimer=setInterval(()=>{_fetchModuleStore(e,!0)},216e5)),e._isLoadingStore){const t=e._loadingProgress||0,n=e._loadingStatus||"Loading modules";return x`
        ...
        <div class="form-content">
          ...
          `}>
            <div class="code-editor-container">
              <ha-code-editor
                ...
                @value-changed=${n=>(n=>{if(!e._editingModule||!e._config||t)return;const o=e._editingModule.id;if("function"==typeof e._clearCurrentModuleError&&e._clearCurrentModuleError(o),!e._originalModuleState){const t=style_processor.Ki.get(o);t&&(e._originalModuleState=JSON.parse(JSON.stringify(t)))}e._editingModule.code=n,e.stylesYAML&&(e.stylesYAML=null);const a={...style_processor.Ki.get(o)||{},code:n,id:o};style_processor.Ki.set(o,a),updateModuleInConfig(e,o,e._previousModuleId),module_editor_broadcastModuleUpdate(o,a)})(n.detail.value)}
              ></ha-code-editor>
            </div>
          ...
          ${!t&&a?x`
            <div class="bubble-info warning" style="margin-top: 8px;">
              ...
              <div class="content">
                <p style="margin: 0;">
                  ${n?x`Fix the error(s) in the Editor schema (YAML) above to enable saving.`:""}
                  ${n&&o?x`<br>`:""}
                  ${o?x`Fix the error(s) in the CSS/JS template above to enable saving.`:""}
                </p>
              </div>
            </div>
          `:""}
            ...
            <div class="content">
                <div class="export-section">
                    <div class="export-buttons">
                        <button class="icon-button" @click=${()=>{const t=generateYamlExport(e._editingModule);copyToClipboard(e,t,"YAML format copied to clipboard!",i)}}>
                        <ha-icon icon="mdi:content-copy"></ha-icon>
                        Copy YAML
                        </button>
                        
                        <button class="icon-button" @click=${()=>{const t=generateGitHubExport(e._editingModule);copyToClipboard(e,t,"GitHub Discussion format copied to clipboard!",i)}}>
                        <ha-icon icon="mdi:content-copy"></ha-icon>
                        Copy for GitHub
                        </button>
                        
                        <button class="icon-button" @click=${()=>{downloadModuleAsYaml(e,e._editingModule,i)}}>
          ...
          <div class="module-editor-buttons-container">
            ...
            <button class="icon-button ${t||a?"disabled":""}" ?disabled=${t||a} style="flex: 1;" @click=${()=>{t||a||(saveModule(e,e._editingModule),setTimeout(()=>(0,modules_utils.XY)(e),0))}}>
      ...
      <h4 slot="header">
        ...
        ${a.hasUpdates&&o?x`
          <span class="bubble-badge update-badge" style="margin-left: 8px; font-size: 0.8em; vertical-align: middle;">
            <ha-icon icon="mdi:arrow-up-circle-outline"></ha-icon>
            ${a.updateCount} update${a.updateCount>1?"s":""} available
          </span>
        `:""}
      </h4>
  ...
  - trigger:
    ...
    sensor:
      - name: "Bubble Card Modules"
        ...
        ${(()=>{const n=isSlTabGroupAvailable(),a=e._selectedModuleTab||0;return n?x`
        <sl-tab-group 
          id="${t}"
          .selected=${a.toString()}
          @sl-tab-show=${i}>
      ...
      `})()}
        ...
        ${0!==e._selectedModuleTab&&o?makeModuleStore(e):x`
                        ...
                        <div class="module-toggles-container">
                          ...
                          <div class="module-toggles">
                            <button 
                              ...
                              style="${"default"===t&&p?"cursor: default;":""} cursor: pointer;"
          ...
          <hr>
          ${e._showNewModuleForm||e._editingModule||!o?"":x`
