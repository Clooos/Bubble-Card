...
`}function renderHorButtonStackEditor(e){if(!e.buttonAdded)for(e.buttonAdded=!0,e.buttonIndex=0;e._config[e.buttonIndex+1+"_link"];)e.buttonIndex++;return x`
            ...
            <ha-expansion-panel outlined>
                ...
                <div class="content">
                    <ha-form
                      .hass=${e.hass}
                      .data=${e._config}
                      .schema=${[{name:"limit",label:t("editor.calendar.limit"),title:t("editor.calendar.limit"),selector:{number:{step:1,min:1}}},{name:"show_end",label:t("editor.calendar.show_end"),title:t("editor.calendar.show_end"),selector:{boolean:{}}},{name:"show_progress",label:t("editor.calendar.show_progress"),title:t("editor.calendar.show_progress"),selector:{boolean:{}}}]}   
                      .computeLabel=${e._computeLabelCallback}
                      @value-changed=${e._valueChanged}
                    ></ha-form>
                </div>
    ...
    `}function makeSubButtonPanel(e){const t=e._config?.sub_button?.map(((t,n)=>{if(!t)return;const o="sub_button."+n+".",a=t.entity??e._config.entity,i=a?.startsWith("input_select")||a?.startsWith("select")||t.select_attribute,r=e.hass.states[a]?.attributes,s=e._selectable_attributes.some((e=>r?.[e])),l=Object.keys(e.hass.states[a]?.attributes||{}).map((t=>{let n=e.hass.states[a];return{label:e.hass.formatEntityAttributeName(n,t),value:t}})).filter((t=>e._selectable_attributes.includes(t.value))),c=t.visibility??[];return x`
            <ha-expansion-panel outlined>
                <h4 slot="header">
                    <ha-icon icon="mdi:border-radius"></ha-icon>
                    ${e._config.sub_button[n]?"Button "+(n+1)+(t.name?" - "+t.name:""):"New button"}
                    <div class="button-container">
                        <button class="icon-button header" @click="${o=>{o.stopPropagation();let a=[...e._config.sub_button];a.splice(n,1),e._config.sub_button=a,e._valueChanged({target:{configValue:"sub_button."+(n-1),value:t}}),e.requestUpdate()}}">
                            <ha-icon icon="mdi:delete"></ha-icon>
                        </button>
                        ${n>0?x`<button class="icon-button header" @click="${t=>{if(t.stopPropagation(),n>0){let t=[...e._config.sub_button];[t[n],t[n-1]]=[t[n-1],t[n]],e._config.sub_button=t,e._valueChanged({target:{configValue:"sub_button."+n,value:e._config.sub_button[n]}})}e.requestUpdate()}}">
                            <ha-icon icon="mdi:arrow-left"></ha-icon>
                        </button>`:""}
                        ${n<e._config.sub_button.length-1?x`<button class="icon-button header" @click="${t=>{if(t.stopPropagation(),n<e._config.sub_button.length-1){let t=[...e._config.sub_button];[t[n],t[n+1]]=[t[n+1],t[n]],e._config.sub_button=t,e._valueChanged({target:{configValue:"sub_button."+n,value:e._config.sub_button[n]}})}e.requestUpdate()}}">
        ...
        <div class="form-content">
          ...
          <div class="css-editor-container">
            <ha-code-editor
              ...
              @value-changed=${n=>(n=>{if(!e._editingModule||!e._config||t)return;const o=e._editingModule.id;if(!e._originalModuleState){const t=style_processor.Ki.get(o);t&&(e._originalModuleState=JSON.parse(JSON.stringify(t)))}e._editingModule.code=n,e.stylesYAML&&(e.stylesYAML=null);const a={...style_processor.Ki.get(o)||{},code:n,id:o};style_processor.Ki.set(o,a);const i=e.shadowRoot?.querySelector(".css-editor-container");i&&(i.classList.add("applying-styles"),setTimeout((()=>{i.classList.remove("applying-styles")}),300)),updateModuleInConfig(e,o,e._previousModuleId),refreshStyles(e),broadcastModuleUpdate(o,a)})(n.detail.value)}
              class="code-editor"
            ></ha-code-editor>
          </div>
          <span class="helper-text">
      ...
      - name: "Bubble Card Modules"
        ...
        ${0===e._selectedModuleTab?x`
          ...
          ${e._showNewModuleForm||e._editingModule?renderModuleEditorForm(e):x`
            ...
            ${Array.from(style_processor.Ki.keys()).sort(((e,t)=>"default"===e?-1:"default"===t?1:0)).map((a=>{const{name:i,description:r,formSchema:s,supportedCards:l,unsupportedCard:c,creator:d,moduleLink:u,moduleVersion:p}=(0,modules_utils.a7)(a),h=e._config.modules?.includes(a),b=e._config.card_type??"";let m=!1;m=l&&Array.isArray(l)&&l.length>0?!l.includes(b):c.includes(b);const g=e._config[a],f=s&&s.length>0?e._getProcessedSchema(a,s,g):[],_=n.modules.some((e=>e.id===a))&&t,y=_?n.modules.find((e=>e.id===a)):null;return x`
                <ha-expansion-panel outlined class="${m?"disabled":""}">
                  <h4 slot="header">
                    <ha-icon
                  ...
                  <div class="content">
                      ...
                      <div class="module-actions">
                        ${_?x`
                          <button 
                            ...
                            style="margin: 0 24px;"
                            @click=${()=>{e._selectedModuleTab=1,e._storeSearchQuery=i,e.requestUpdate()}} 
                            title="Update Module"
                          >
                            <ha-icon icon="mdi:arrow-up-circle-outline"></ha-icon>
                            Update
                        ...
                        `:""}
                        <button class="icon-button" @click=${()=>editModule(e,a)} title="Edit Module">
                          <ha-icon icon="mdi:pencil"></ha-icon>
                        </button>
                        ${_isModuleInstalledViaYaml&&_isModuleInstalledViaYaml(a)||"default"===a?"":x`
                            <button class="icon-button" @click=${()=>deleteModule(e,a)} title="Delete Module">
                              <ha-icon icon="mdi:delete"></ha-icon>
                            </button>
                          `}
                      </div>
                    ...
                    ${s.length>0?x`
                        ...
                        <ha-form
                          ...
                          .computeLabel=${e._computeLabelCallback}
                          .disabled=${!h}
                          @value-changed=${t=>e._valueChangedInHaForm(t,a,s)}
                        ></ha-form>
                        <hr>
                      `:""}
