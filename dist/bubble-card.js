      ...
      <ha-expansion-panel outlined class="bc-object-item">
        ...
        <div class="bc-object-item-content">
          <ha-form
            .hass=${this.hass}
            .data=${a}
            .schema=${this._generateSchema(this.selector?.bc_object?.fields,a)}
            .disabled=${this.disabled}
