...
`;case"horizontal-buttons-stack":return function(e){if(!e.buttonAdded)for(e.buttonAdded=!0,e.buttonIndex=0;e._config[e.buttonIndex+1+"_link"];)e.buttonIndex++;return tt.qy`
    ...
    `}(this);case void 0:return tt.qy`
        ...
        `}makeShowState(e=this._config,t="",n=!1,o){const i=e?.entity??this._config.entity??"",a="name"===this._config.button_type,r=i?.startsWith("input_select")||i?.startsWith("select")||e.select_attribute,s="sub_button"===n||"string"==typeof n&&n.startsWith("sub_button"),l=s&&("select"===e?.sub_button_type||!e?.sub_button_type&&r),c=e?.show_attribute?Object.keys(this.hass.states[i]?.attributes||{}).map(e=>{let t=this.hass.states[i];return{label:this.hass.formatEntityAttributeName(t,e),value:e}}):[];return tt.qy`
            ...
            ${this._renderConditionalContent(s,tt.qy`
            ...
            `)}
            ${this._renderConditionalContent(s&&(e?.show_background??!0),tt.qy`
            ...
            `)}
            ${this._renderConditionalContent(s&&(e?.state_background??!0)&&i.startsWith("light"),tt.qy`
            ...
            `)}
            ${this._renderConditionalContent(!s&&i.startsWith("light"),tt.qy`
            ...
            ${this._renderConditionalContent(e?.show_attribute,tt.qy`
                <ha-form
                    ...
                    .schema=${[{name:"attribute",selector:{select:{options:c,mode:"dropdown"}}}]}
                    .disabled=${a&&!s}
