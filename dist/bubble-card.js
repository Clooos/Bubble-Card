      ...
      - name: "Bubble Card Modules"
        ...
        ${0===e._selectedModuleTab?x`
          ...
          ${e._showNewModuleForm||e._editingModule?renderModuleEditorForm(e):x`
            ...
            ${Array.from(style_processor.Ki.keys()).sort(((e,t)=>"default"===e?-1:"default"===t?1:0)).map((a=>{const{name:i,description:r,formSchema:s,supportedCards:l,unsupportedCard:c,creator:d,moduleLink:u,moduleVersion:p}=(0,modules_utils.a7)(a),h=e._config.modules?.includes(a),b=e._config[a];void 0===e._workingModuleConfigs[a]&&(e._workingModuleConfigs[a]=structuredClone(b??{}));const m=e._workingModuleConfigs[a],g=e._config.card_type??"";let f=!1;f=l&&Array.isArray(l)&&l.length>0?!l.includes(g):c.includes(g);const _=s&&s.length>0?e._getProcessedSchema(a,s,b):[],y=n.modules.some((e=>e.id===a))&&t,v=y?n.modules.find((e=>e.id===a)):null;return x`
