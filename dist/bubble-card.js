    ...
    <div class="module-store">
      <div class="store-header">
        ...
        <div class="store-search">
          <ha-form
            .hass=${e.hass}
            .data=${{search:e._storeSearchQuery||""}}
            .schema=${[{name:"search",selector:{text:{type:"search"}}}]}
            .computeLabel=${()=>"Search for a module"}
            @value-changed=${t=>{e._storeSearchQuery=t.detail.value.search,e.requestUpdate()}}
          ></ha-form>
        </div>
            ...
            <div class="my-modules-controls">
              <div class="my-modules-top-row">
                <div class="my-modules-search">
                  <ha-form
                    .hass=${e.hass}
                    .data=${{search:e._myModulesSearchQuery||""}}
                    .schema=${[{name:"search",selector:{text:{type:"search"}}}]}
                    .computeLabel=${()=>"Search modules"}
                    @value-changed=${t=>{e._myModulesSearchQuery=t.detail.value.search,e.requestUpdate()}}
                  ></ha-form>
                </div>
