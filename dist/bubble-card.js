(()=>{"use strict";let e,n="v2.0.0-beta.1";function t(e){let n=[220,220,190];for(let t=0;t<3;t++)if(e[t]<n[t])return!1;return!0}function i(n,t,i=1){if(n.startsWith("#"))if(4===n.length){let o=Math.min(255,parseInt(n.charAt(1).repeat(2),16)*i),a=Math.min(255,parseInt(n.charAt(2).repeat(2),16)*i),s=Math.min(255,parseInt(n.charAt(3).repeat(2),16)*i);e="rgba("+o+", "+a+", "+s+", "+t+")"}else{let o=Math.min(255,parseInt(n.slice(1,3),16)*i),a=Math.min(255,parseInt(n.slice(3,5),16)*i),s=Math.min(255,parseInt(n.slice(5,7),16)*i);e="rgba("+o+", "+a+", "+s+", "+t+")"}else if(n.startsWith("rgb")){let o=n.match(/\d+/g);e="rgba("+Math.min(255,o[0]*i)+", "+Math.min(255,o[1]*i)+", "+Math.min(255,o[2]*i)+", "+t+")"}return e}const o=(e,n,t,i)=>{i=i||{},t=null==t?{}:t;const o=new Event(n,{bubbles:void 0===i.bubbles||i.bubbles,cancelable:Boolean(i.cancelable),composed:void 0===i.composed||i.composed});return o.detail=t,e.dispatchEvent(o),o},a=e=>{o(window,"haptic",e)};function s(e,n){e.callService("homeassistant","toggle",{entity_id:n})}function l(e,n=e.config.entity,t=e.config.icon){const i=u(e,"icon",n),o=t,a=n?.split(".")[0],s={light:"mdi:lightbulb",switch:"mdi:toggle-switch",sensor:"mdi:sensor",media_player:"mdi:speaker",climate:"mdi:thermostat",binary_sensor:"mdi:radiobox-blank",cover:"mdi:window-shutter",fan:"mdi:fan",lock:"mdi:lock",alarm_control_panel:"mdi:shield",camera:"mdi:camera",automation:"mdi:playlist-play",group:"mdi:google-circles-communities",input_boolean:"mdi:toggle-switch-off-outline",input_number:"mdi:numeric",input_text:"mdi:form-textbox",input_select:"mdi:format-list-bulleted",scene:"mdi:palette",script:"mdi:file-document-outline"};return o||i||(s[a]?s[a]:"")}function r(e){const n=e.config.entity,i="var(--accent-color)",o=u(e,"rgb_color");if(!n)return i;if(!1===n.startsWith("light."))return i;const a="rgba(255, 220, 200)",s=b(e)?a:"rgba(255, 255, 255)";return o?t(o)?a:`rgba(${o.join(", ")})`:s}function c(e){if(e.config.force_icon)return"";const n=u(e,"entity_picture_local"),t=u(e,"entity_picture");return n||t||""}function d(e){const n=e.config.name,t=u(e,"friendly_name");return n||t||""}function p(e,n=e.config.entity){return e._hass.states[n]?.state??""}function u(e,n,t=e.config.entity){return e._hass.states[t]?.attributes[n]??""}function h(e,n){return e.config.entity?.startsWith(n+".")??!1}function b(e,n=e.config.entity){const t=p(e,n),i=Number(t);return!!(["on","open","opening","closing","cleaning","true","idle","home","playing","locked","occupied","available","running","active","connected"].includes(t)||i>0)}function m(e,n=""){const t=document.createElement(e);return""!==n&&n.split(" ").forEach((e=>{t.classList.add(e)})),t}function g(e,n){if(e.previousText===n)return;const t=e.className.split(" ").find((e=>e.startsWith("bubble-")));e.innerHTML=n,e.style="",requestAnimationFrame((()=>{if(e.scrollWidth>e.parentNode.offsetWidth){const i='<span class="bubble-scroll-separator">|</span>';e.innerHTML=`<span>${n+i+n+i}</span>`;const o=function(e){return`\n            .${e} {\n                white-space: nowrap;\n                mask-image: linear-gradient(to right, transparent, black calc(0% + 8px), black calc(100% - 8px), transparent);\n                caca: 100px;\n            }\n            .${e} span {\n                display: inline-block;\n                animation: scroll 14s linear infinite;\n            }\n\n            .bubble-scroll-separator {\n                opacity: .3; \n                margin: 0 6px 0 8px;\n            }\n\n            @keyframes scroll {\n                from { transform: translateX(0%); }\n                to { transform: translateX(-50%); }\n            }\n        `}(t);e.styleElement=m("style"),e.styleElement.innerHTML=o,e.appendChild(e.styleElement)}})),e.previousText=n}function f(e,n){if(!e)return"";const t=new Date(e),i=new Date,o=Math.floor((i-t)/1e3);let a,s;return o<60?(a="second",s=o):o<3600?(a="minute",s=Math.floor(o/60)):o<86400?(a="hour",s=Math.floor(o/3600)):(a="day",s=Math.floor(o/86400)),new Intl.RelativeTimeFormat(n,{numeric:"auto"}).format(-s,a)}function _(e,n=300){let t;return(...i)=>{void 0===t&&(e(...i),t=setTimeout((()=>{t=void 0}),n))}}class y{constructor(e,n,t,i){this.element=e,this.config=n,this.sendActionEvent=t,this.defaultEntity=i,this.tapTimeout=null,this.lastTap=0,this.startTime=null}handleStart(e){e.stopPropagation(),e.stopImmediatePropagation(),this.startTime=Date.now(),clearTimeout(this.tapTimeout)}handleEnd(){if(null===this.startTime)return;const e=Date.now(),n=e-this.startTime,t=e-this.lastTap;this.lastTap=e,this.startTime=null,n>300?this.sendActionEvent(this.element,this.config,"hold"):t<300?this.sendActionEvent(this.element,this.config,"double_tap"):this.tapTimeout=setTimeout((()=>{this.sendActionEvent(this.element,this.config,"tap",this.defaultEntity)}),300)}}function v(e,n,t,i){const o=n.tap_action??{action:"more-info"},a=n.double_tap_action||{action:"toggle"},s=n.hold_action||{action:"toggle"};!function(e,n,t){setTimeout((()=>{const i=new Event("hass-action",{bubbles:!0,composed:!0});i.detail={config:n,action:t},e.dispatchEvent(i)}),1)}(e,{entity:n.entity??i,tap_action:o,double_tap_action:a,hold_action:s},t)}function x(e,n,t){const i=new y(e,n,v,t);e.addEventListener("pointerdown",i.handleStart.bind(i)),e.addEventListener("pointerup",i.handleEnd.bind(i)),e.addEventListener("contextmenu",(e=>e.preventDefault())),e.style.cursor="pointer"}function w(e,n){e.addEventListener("click",(()=>function(e){void 0!==e&&(a("success"),e.style.display="",e.style.animation="tap-feedback .5s",setTimeout((()=>{e.style.animation="none",e.style.display="none"}),500))}(n)))}let k=0;function C(e){void 0===e.composedPath().find((e=>e.classList&&e.classList.contains("bubble-pop-up")||"HA-MORE-INFO-DIALOG"===e.nodeName||"HA-DIALOG-DATE-PICKER"===e.nodeName))&&$()}function $(){const e=window.location.href.split("#")[0];history.replaceState(null,"",e),window.dispatchEvent(new Event("location-changed"))}function S(e){const n=e.startsWith("#")?window.location.href.split("#")[0]+e:e;history.pushState(null,"",n),window.dispatchEvent(new Event("location-changed"))}function T(e){e.popUp.classList.contains("is-popup-opened")||(e.popUp.classList.add("is-popup-opened"),window.clearTimeout(e.removeDomTimeout),e.popUp.parentNode!==e.verticalStack&&e.verticalStack.appendChild(e.popUp),k++,clearTimeout(e.closeTimeout),clearTimeout(e.hideContentTimeout),document.body.style.overflow="hidden",e.popUp.style.display="",e.popUp.addEventListener("touchstart",e.resetCloseTimeout),requestAnimationFrame((()=>{e.popUp.classList.remove("is-popup-closed"),window.addEventListener("click",C)})),e.config.auto_close>0&&(e.closeTimeout=setTimeout($,e.config.auto_close)))}const L="\n  .bubble-backdrop {\n    position: fixed;\n    top: 0;\n    left: 0;\n    width: 100%;\n    height: 100%;\n    z-index: 5;\n    opacity: 0;\n    transition: opacity 0.3s;\n    display: flex;\n  }\n\n  .bubble-backdrop.is-visible {\n    opacity: 1;\n    backdrop-filter: blur(16px);\n    -webkit-backdrop-filter: blur(16px);\n  }\n\n  .bubble-backdrop.is-hidden {\n    opacity: 0;\n    backdrop-filter: none;\n    -webkit-backdrop-filter: none;\n    pointer-events: none;\n  }\n";let O,E=!1;function B(e){if(O)return O;const n=getComputedStyle(document.body).getPropertyValue("--ha-card-background")??getComputedStyle(document.body).getPropertyValue("--card-background-color"),t=m("style");t.innerHTML=`\n    ${L}\n    .bubble-backdrop {\n      background-color: ${i(n,.7,.7)};\n    }\n  `,document.head.appendChild(t);const o=m("style");document.head.appendChild(o);const a=m("div","bubble-backdrop backdrop is-hidden");return e.config.hide_backdrop&&(a.style.display="none",a.style.pointerEvents="none"),document.body.appendChild(a),O={hideBackdrop:function(){a.classList.add("is-hidden"),a.classList.remove("is-visible")},showBackdrop:function(){a.classList.add("is-visible"),a.classList.remove("is-hidden")},backdropElement:a,backdropCustomStyle:o},O}async function V(e){if("pop-up"!==e.cardType){if(e.getRootNode()instanceof ShadowRoot==0)return;!function(e){try{e.cardType="pop-up",e.verticalStack=e.getRootNode(),e.popUp=e.verticalStack.querySelector("#root"),e.popUp.classList.add("pop-up","bubble-pop-up","is-popup-closed"),e.verticalStack.removeChild(e.popUp),e.elements={},B(e),E=E||(e.config.hide_backdrop??!1),e.popUp.style.setProperty("--custom-height-offset-desktop",e.config.margin_top_desktop??"0px"),e.popUp.style.setProperty("--custom-height-offset-mobile",e.config.margin_top_mobile??"0px"),e.popUp.style.setProperty("--custom-margin",`-${e.config.margin??7}px`),e.popUp.style.setProperty("--custom-backdrop-filter",E?"none":`blur(${e.config.bg_blur??10}px)`),e.popUp.style.setProperty("--custom-popup-filter",E?`blur(${e.config.bg_blur??10}px)`:"none"),e.popUp.style.setProperty("--custom-shadow-opacity",(e.config.shadow_opacity??0)/100);const n=m("style");e.elements.customStyle=m("style"),n.innerText="\n  .pop-up.card-content {\n      width: 100% !important;\n      padding: 0 !important;\n  }\n  .pop-up {\n      transition: transform .36s;\n      position: fixed;\n      width: 100%;\n      max-width: 100%;\n      border-radius: 42px 42px 0 0;\n      box-sizing: border-box;\n      margin-left: var(--custom-margin);\n      grid-auto-rows: min-content;\n      padding: 18px 18px 90px 18px;\n      height: calc(100% - var(--custom-height-offset-mobile) - var(--header-height)) !important;\n      -ms-overflow-style: none; /* for Internet Explorer, Edge */\n      scrollbar-width: none; /* for Firefox */\n      overflow-y: auto; \n      overflow-x: hidden; \n      z-index: 6 !important;\n      bottom: 0;\n      left: calc(var(--mdc-drawer-width) / 2 + 50% - (var(--desktop-width) / 2));\n      grid-gap: 14px !important;\n      gap: 14px !important;\n      column-gap: 14px !important;\n      --grid-gap: 14px;\n      --vertical-stack-card-gap: 14px;\n      --horizontal-stack-card-gap: 14px;\n      --stack-card-gap: 14px;\n  }\n  .pop-up::-webkit-scrollbar {\n      display: none; /* for Chrome, Safari, and Opera */\n  }\n  .pop-up > :first-child {\n      position: sticky;\n      top: 0;\n      z-index: 1;\n      background: none !important;\n      overflow: visible;\n  }\n  .is-popup-opened {\n      transform: translateY(0);\n      box-shadow: 0px 0px 50px rgba(0, 0, 0, var(--custom-shadow-opacity));\n      backdrop-filter: var(--custom-popup-filter);\n      -webkit-backdrop-filter: var(--custom-popup-filter);\n  }\n  .is-popup-closed { \n      transform: translateY(100%) !important;\n      box-shadow: none !important;\n      backdrop-filter: none !important;\n      -webkit-backdrop-filter: none !important;\n  }\n  @media only screen and (min-width: 600px) {\n      .pop-up {\n          margin: 0 !important;\n          min-width: var(--desktop-width);\n          width: calc(var(--mobile-width) - var(--mdc-drawer-width)) !important;\n          height: calc(100% - var(--custom-height-offset-desktop) - var(--header-height)) !important;\n          left: calc(50% - (var(--desktop-width) / 2));\n      }\n  }\n  @media only screen and (min-width: 870px) {\n      .pop-up {\n        left: calc(var(--mdc-drawer-width) / 2 + 50% - (var(--desktop-width) / 2));\n      }\n      .is-sidebar-hidden.pop-up {\n        width: var(--desktop-width) !important;\n      }\n  }\n  .pop-up.editor {\n      position: inherit !important;\n      width: 100% !important;\n      padding: 18px !important;\n      backdrop-filter: none !important;\n      display: block !important;\n      transform: none !important;\n      height: auto !important;\n      min-width: auto;\n      border-radius: 42px;\n  }\n",e.popUp.appendChild(n),e.popUp.appendChild(e.elements.customStyle)}catch(e){console.error(e)}}(e),function(e){try{e.elements.style=m("style"),e.elements.style.innerText="\n  ha-card {\n      margin-top: 0 !important;\n  }\n  .bubble-header-container {\n      display: inline-flex;\n      height: 50px;\n      width: 100%;\n      margin: 0;\n      padding: 0;\n  }\n  .bubble-icon-container {\n    display: flex;\n    flex-wrap: wrap;\n    align-content: center;\n    justify-content: center;\n    min-width: 38px;\n    min-height: 38px;\n    margin: 6px;\n    border-radius: 50%;\n    background-color: var(--card-background-color, var(--ha-card-background));\n    overflow: hidden;\n    z-index: 1;\n    position: relative;\n    cursor: pointer;\n  }\n  .bubble-icon-container::after {\n    content: '';\n    background-color: currentColor;\n    position: absolute;\n    display: block;\n    width: 100%;\n    height: 100%;\n    transition: all 1s;\n    left: 0;\n    right: 0;\n    opacity: 0;\n  }\n  .is-light.is-on .bubble-icon-container::after {\n    opacity: 0.2;\n  }\n  .is-unavailable.is-light .bubble-icon-container::after {\n    opacity: 0;\n  }\n\n  .bubble-icon {\n    display: flex;\n    opacity: 0.6;\n    height: 22px;\n    width: 22px;\n  }\n\n  .is-on .bubble-icon {\n    filter: brightness(1.1);\n    opacity: 1;\n  }\n\n  .bubble-entity-picture {\n    background-size: cover;\n    background-position: center;\n    height: 100%;\n    width: 100%;\n  }\n  .bubble-header {\n      align-items: center;\n      display: inline-flex;\n      position: relative;\n      padding-right: 6px;\n      z-index: 1;\n      flex-grow: 1;\n      transition: background 1s;\n      border-radius: 25px;\n      margin-right: 14px;\n      backdrop-filter: blur(14px);\n      -webkit-backdrop-filter: blur(14px);\n  }\n  .bubble-name {\n      display: inline-flex;\n      margin: 0 18px 0 0;\n      padding: 4px;\n      z-index: 1;\n      font-size: 18px;\n  }\n  .bubble-state {\n      display: inline-flex;\n      font-size: 16px;\n      min-width: fit-content;\n      flex-grow: 1;\n  }\n  .bubble-power-button {\n      cursor: pointer;\n      width: 24px;\n      height: 24px;\n      border-radius: 12px;\n      margin: 0 10px;\n      background: none !important;\n      justify-content: flex-end;\n      background-color: var(--background-color,var(--secondary-background-color));\n  }\n  .bubble-close-button {\n      height: 50px;\n      width: 50px;\n      border: none;\n      border-radius: 50%;\n      z-index: 1;\n      background: var(--background-color,var(--secondary-background-color));\n      color: var(--primary-text-color);\n      flex-shrink: 0;\n      cursor: pointer;\n  }\n",e.elements.cardCustomStyle=m("style"),e.content.innerHTML="",e.content.appendChild(e.elements.style),e.content.appendChild(e.elements.cardCustomStyle);const n=getComputedStyle(document.body).getPropertyValue("--ha-card-background")??getComputedStyle(document.body).getPropertyValue("--card-background-color"),t=i(e.config.bg_color?e.config.bg_color:n,(e.config.bg_opacity??88)/100,1.02);e.popUp.style.backgroundColor=t,e.popUp.style.setProperty("--desktop-width",e.config.width_desktop??"500px"),e.config.is_sidebar_hidden&&e.popUp.classList.add("is-sidebar-hidden"),e.config.close_on_click&&e.popUp.addEventListener("touchend",$);const o=function(e){const{hideBackdrop:n,showBackdrop:t}=B(e);return function(){e.config.hash===location.hash?T(e):function(e){!1!==e.popUp.classList.contains("is-popup-opened")&&(k--,document.body.style.overflow="",e.popUp.classList.add("is-popup-closed"),e.popUp.classList.remove("is-popup-opened"),e.hideContentTimeout=setTimeout((function(){e.popUp.style.display="none"}),380),e.resetCloseTimeout=()=>{clearTimeout(e.closeTimeout)},e.popUp.removeEventListener("touchstart",e.resetCloseTimeout),window.removeEventListener("click",C),e.removeDomTimeout=window.setTimeout((()=>{e.popUp.parentNode===e.verticalStack&&e.verticalStack.removeChild(e.popUp)}),360))}(e),0===k?n():t()}}(e);setTimeout((()=>{o()}),0),window.addEventListener("location-changed",o),window.addEventListener("keydown",(n=>{"Escape"===n.key&&e.config.hash===location.hash&&$()}))}catch(e){console.error(e)}}(e),function(e){e.elements.closeIcon=m("ha-icon","bubble-close-icon"),e.elements.closeIcon.icon="mdi:close",e.elements.closeButton=m("button","bubble-close-button close-pop-up"),e.elements.closeButton.addEventListener("click",$),e.elements.closeButton.appendChild(e.elements.closeIcon),e.elements.icon=m("ha-icon","bubble-icon icon"),e.elements.image=m("div","bubble-entity-picture entity-picture"),e.elements.iconContainer=m("div","bubble-icon-container icon-container"),e.elements.iconContainer.appendChild(e.elements.icon),e.elements.iconContainer.appendChild(e.elements.image),x(e.elements.iconContainer,e.config),e.elements.name=m("h2","bubble-name"),e.elements.state=m("p","bubble-state"),e.elements.header=m("div","bubble-header"),e.elements.header.appendChild(e.elements.iconContainer),e.elements.header.appendChild(e.elements.name),e.elements.header.appendChild(e.elements.state),e.config.entity&&(e.elements.powerIcon=m("ha-icon","bubble-power-button power-button"),e.elements.powerIcon.icon="mdi:power",e.elements.powerIcon.addEventListener("click",(()=>{s(e._hass,e.config.entity)})),e.elements.header.appendChild(e.elements.powerIcon)),e.elements.headerContainer=m("div","bubble-header-container"),e.elements.headerContainer.setAttribute("id","header-container"),e.elements.headerContainer.appendChild(e.elements.header),e.elements.headerContainer.appendChild(e.elements.closeButton),e.content.appendChild(e.elements.headerContainer)}(e)}("pop-up"!==e.cardType||e.popUp.classList.contains("is-popup-opened")||function(e,n){return!(!n.classList.contains("editor")||e.config===e.previousConfig||(e.previousConfig=e.config,0))}(e,e.popUp))&&(function(e){const n=b(e),t=l(e),i=c(e);h(e,"light")&&n?e.elements.iconContainer.style.color=r(e):e.elements.iconContainer.style.color="",""!==i?(e.elements.image.style.backgroundImage="url("+i+")",e.elements.icon.style.display="none",e.elements.image.style.display=""):""!==t?(e.elements.icon.icon=t,e.elements.icon.style.color=n?r(e):"inherit",e.elements.icon.style.display="",e.elements.image.style.display="none"):(e.elements.icon.style.display="none",e.elements.image.style.display="none")}(e),function(e){const n=e._hass.states[e.config.entity],i=n?.attributes.rgb_color,o=n?.state;if(i){const n=t(i)?"rgba(255, 220, 200, 0.5)":`rgba(${i}, 0.5)`;e.elements.header.style.backgroundColor=n}else"on"==o&&e.config.entity?.startsWith("light.")?e.elements.header.style.backgroundColor="rgba(255, 220, 200, 0.5)":e.elements.header.style.backgroundColor="on"==o?"var(--accent-color)":"var(--background-color, var(--secondary-background-color))"}(e),function(e){const n=d(e);n!==e.elements.name.innerText&&(e.elements.name.innerText=n)}(e),function(e){const n=e._hass.states[e.config.state],t=n?e._hass.formatEntityState(n):"";e.config.state?t!==e.elements.state.innerText&&(e.elements.state.style.display="",e.elements.state.innerText=`${t} ${e.config.text??""}`):e.elements.state.style.display="none"}(e),function(e){"unavailable"===p(e)?e.card.classList.add("is-unavailable"):e.card.classList.remove("is-unavailable"),h(e,"light")?e.card.classList.add("is-light"):e.card.classList.remove("is-light"),b(e)?e.card.classList.add("is-on"):e.card.classList.remove("is-on")}(e),function(e){const n=p(e),{backdropCustomStyle:t}=B(e),i=e.config.styles?Function("hass","entityId","state","return `"+e.config.styles+"`;")(e._hass,e.config.entity,n):"";e.elements.customStyle.innerText=i,e.elements.cardCustomStyle.innerText=i,t.innerText=i}(e)),function(e){let n=e.config.trigger_entity??"",t=e.config.trigger_state??"",i=e.config.trigger_close??!1,o=e._hass.states[n]?.state;n&&t&&e.oldTriggerEntityState!==o&&(e.config.hash===location.hash?i&&t!==o&&$():o===t&&S(e.config.hash),e.oldTriggerEntityState=o)}(e),function(e){const n=e.verticalStack.host.closest("hui-card-preview");e.editor||null!==n?e.popUp.classList.add("editor"):e.popUp.classList.remove("editor"),function(e){const{hideBackdrop:n,showBackdrop:t}=B(e),i=e.verticalStack.host.closest("hui-card-preview");e.editor||null!==i?(n(),window.clearTimeout(e.removeDomTimeout),e.popUp.parentNode!==e.verticalStack&&e.verticalStack.appendChild(e.popUp)):e.config.hash===location.hash?(T(e),t()):e.popUp.parentNode===e.verticalStack&&e.verticalStack.removeChild(e.popUp)}(e)}(e)}let P=!1;function A(e,n){const t=e.config[`${n}_name`]??"",i=e.config[`${n}_icon`]??"",o=e.config[`${n}_pir_sensor`],s=e.config[`${n}_link`],l=e.config[`${n}_entity`];P=P||location.hash===s;const r=m("ha-icon","bubble-icon icon");r.icon=i;const c=m("div","bubble-name name");c.innerText=t;const d=m("div","bubble-background-color background-color"),p=m("div","bubble-background background"),u=m("div",`bubble-button bubble-button-${n} button ${s.substring(1)}`);let h=localStorage.getItem(`bubbleButtonWidth-${s}`);return u.style.width=`${h}px`,u.appendChild(r),u.appendChild(c),u.appendChild(d),u.appendChild(p),u.addEventListener("click",(()=>{location.hash!==s&&(P=!1),P?$():S(s),P=!P,a("light")})),u.icon=r,u.name=c,u.backgroundColor=d,u.background=p,u.pirSensor=o,u.lightEntity=l,u.link=s,u.index=n,window.addEventListener("urlChanged",(function(){e.config.highlight_current_view&&(location.pathname===s||location.hash===s?u.classList.add("highlight"):u.classList.remove("highlight"))})),e.elements.buttons.push(u),u}function I(e){const n=e.config.button_type,t=e._hass.states[e.config.entity],i=e.config.attribute??"",o="state"===n,a=e.config.show_name??!0,s=e.config.show_icon??!0,l=e.config.show_state??o,r=e.config.show_attribute??o,c=e.config.show_last_updated??"";let d,p,u=t&&l?e._hass.formatEntityState(t):"";if(r)if(i)d=t?e._hass.formatEntityAttributeValue(t,i):"";else switch(n){case"switch":case"custom":p=t?f(t.last_updated,e._hass.locale.language):"";break;case"slider":const n=h(e,"cover")?"current_subButton":h(e,"light")&&"off"!==t.state?"brightness":h(e,"media_player")&&"off"!==t.state?"volume_level":null;d=t&&n?e._hass.formatEntityAttributeValue(t,n):"";break;default:d=""}c&&(p=t?f(t.last_updated,e._hass.locale.language):""),"Unknown"===u&&(u=""),"Unknown"===d&&(d="");let b="";function m(e){return e.charAt(0).toUpperCase()+e.slice(1)}u&&(b+=u),p&&(b&&(b+="off"!==u.toLowerCase()?" ":" - "),b+="off"===u.toLowerCase()?m(p):p),d&&(b&&(b+=" - "),b+=d),b=m(b),e.elements.name.style.display=a?z.name.display:"none",s?(e.elements.iconContainer.style.display=z.iconContainer.display,e.elements.nameContainer.style.marginLeft=z.iconContainer.marginLeft):(e.elements.iconContainer.style.display="none",e.elements.nameContainer.style.marginLeft="16px"),""===b?e.elements.state.style.display="none":e.previousState!==b&&(e.elements.state.style.display=z.state.display,e.elements.state.innerText=b,g(e.elements.state,b),e.previousState=b)}const z={name:{display:""},iconContainer:{display:"",marginLeft:""},state:{display:""}},D={subButtonContainer:{position:"relative",display:"flex",justifyContent:"end",right:"8px",alignContent:"center",gap:"8px"},subButton:{flexWrap:"nowrap",flexDirection:"row-reverse",alignItems:"center",justifyContent:"center",position:"relative",right:"0",boxSizing:"border-box",width:"min-content",minWidth:"36px",height:"36px",verticalAlign:"middle",fontSize:"12px",color:"white",borderRadius:"32px",padding:"0 8px",overflow:"hidden",whiteSpace:"nowrap",zIndex:"1",transition:"all 0.5s ease-in-out"},nameContainer:{display:"flex"}};function H(e){return e.config.button_type||"switch"}function U(e,n){if(h(e,"light"))e._hass.callService("light","turn_on",{entity_id:e.config.entity,brightness:255*n/100});else if(h(e,"media_player"))e._hass.callService("media_player","volume_set",{entity_id:e.config.entity,volume_level:n/100});else if(h(e,"cover"))e._hass.callService("cover","set_cover_position",{entity_id:e.config.entity,position:n});else if(h(e,"input_number")){const t=u(e,"min"),i=u(e,"max");e._hass.callService("input_number","set_value",{entity_id:e.config.entity,value:Math.round((i-t)*n/100-i)})}}const M=_(U);function F(e,n,t=!1){const i=e.elements.rangeSlider.getBoundingClientRect(),o=100*(n-i.left)/i.width,a=Math.min(100,Math.max(0,o));e.elements.rangeFill.style.transform=`translateX(${a}%)`,t?M(e,a):U(e,a)}const N="\n    ha-card {\n        margin-top: 0;\n        background: none;\n        opacity: 1;\n    }\n    .is-unavailable {\n        opacity: 0.5;\n    }\n\n    .bubble-button-card-container {\n        position: relative;\n        width: 100%;\n        height: 50px;\n        background-color: var(--background-color-2,var(--secondary-background-color));\n        border-radius: 25px;\n        mask-image: radial-gradient(white, black);\n        -webkit-transform: translateZ(0);\n        overflow: hidden;\n        touch-action: pan-y;\n    }\n\n    .bubble-button-card,\n    .bubble-range-slider {\n        display: flex;\n        position: absolute;\n        justify-content: space-between;\n        align-items: center;\n        height: 100%;\n        width: 100%;\n        transition: background-color 1.5s;\n        background-color: rgba(0,0,0,0);\n    }\n\n    .bubble-range-fill {\n        z-index: -1;\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n        width: 100%;\n        left: -100%;\n        transition: all .3s;\n    }\n    .is-dragging .bubble-range-fill {\n        transition: none;\n    }\n    .is-light .bubble-range-fill {\n        opacity: 0.5;\n    }\n\n    .bubble-button-card {\n        cursor: pointer;\n    }\n    .is-unavailable .bubble-button-card {\n        cursor: not-allowed;\n    }\n\n    .bubble-range-slider {\n        cursor: ew-resize;\n    }\n    .is-unavailable .bubble-range-slider {\n        cursor: not-allowed;\n    }\n\n    .bubble-icon-container {\n        display: flex;\n        flex-wrap: wrap;\n        align-content: center;\n        justify-content: center;\n        min-width: 38px;\n        min-height: 38px;\n        margin: 6px;\n        border-radius: 50%;\n        background-color: var(--card-background-color, var(--ha-card-background));\n        overflow: hidden;\n        z-index: 1;\n        position: relative;\n        cursor: pointer;\n    }\n    .bubble-icon-container::after {\n        content: '';\n        background-color: currentColor;\n        position: absolute;\n        display: block;\n        width: 100%;\n        height: 100%;\n        transition: all 1s;\n        left: 0;\n        right: 0;\n        opacity: 0;\n    }\n    .is-light.is-on .bubble-icon-container::after {\n        opacity: 0.2;\n    }\n    .is-unavailable.is-light .bubble-icon-container::after {\n        opacity: 0;\n    }\n\n    .bubble-icon {\n        display: flex;\n        opacity: 0.6;\n    }\n\n    .is-on .bubble-icon {\n      filter: brightness(1.1);\n      opacity: 1;\n    }\n\n    .bubble-entity-picture {\n        background-size: cover;\n        background-position: center;\n        height: 100%;\n        width: 100%;\n        position: absolute;\n    }\n\n    .bubble-name-container {\n        display: flex;\n        line-height: 1em;\n        flex-direction: column;\n        justify-content: center;\n        flex-grow: 1;\n        font-weight: 600;\n        margin-left: 4px;\n        margin-right: 16px;\n        pointer-events: none;\n        position: relative;\n        overflow: hidden;\n    }\n\n    .bubble-name {\n        margin: 2px 0;\n        white-space: nowrap;\n        display: flex;\n        position: relative;\n    }\n\n    .bubble-state {\n        font-size: 12px;\n        opacity: 0.7;\n        margin: 2px 0;\n        font-weight: normal;\n        white-space: nowrap;\n        display: flex;\n        position: relative;\n    }\n\n    .bubble-feedback-element {\n        position: absolute;\n        top: 0;\n        left: 0;\n        opacity: 0;\n        width: 100%;\n        height: 100%;\n        background-color: rgb(0,0,0);\n    }\n\n    @keyframes tap-feedback {\n        0% {transform: translateX(-100%); opacity: 0;}\n        64% {transform: translateX(0); opacity: 0.1;}\n        100% {transform: translateX(100%); opacity: 0;}\n    }\n";function X(e){const n=H(e);e.cardType!==`button-${n}`&&(function(e){const n=H(e);e.dragging=!1,e.elements={},e.elements.buttonCardContainer=m("div","bubble-button-card-container button-container"),e.elements.buttonCard=m("div","bubble-button-card switch-button"),e.elements.nameContainer=m("div","bubble-name-container name-container"),e.elements.iconContainer=m("div","bubble-icon-container icon-container"),e.elements.name=m("div","bubble-name name"),e.elements.state=m("div","bubble-state state"),e.elements.feedback=m("div","bubble-feedback-element feedback-element"),e.elements.icon=m("ha-icon","bubble-icon icon"),e.elements.image=m("div","bubble-entity-picture entity-picture"),e.elements.style=m("style"),e.elements.customStyle=m("style"),e.elements.feedback.style.display="none",e.elements.style.innerText=N,e.elements.iconContainer.appendChild(e.elements.icon),e.elements.iconContainer.appendChild(e.elements.image),e.elements.nameContainer.appendChild(e.elements.name),e.elements.nameContainer.appendChild(e.elements.state),e.elements.buttonCard.appendChild(e.elements.iconContainer),e.elements.buttonCard.appendChild(e.elements.nameContainer),e.elements.buttonCard.appendChild(e.elements.feedback),e.content.innerHTML="",e.content.appendChild(e.elements.buttonCardContainer),e.content.appendChild(e.elements.style),e.content.appendChild(e.elements.customStyle),e.elements.buttonCardContainer.appendChild(e.elements.buttonCard),e.cardType=`button-${n}`}(e),"switch"===n?function(e){x(e.elements.iconContainer,e.config),w(e.elements.buttonCard,e.elements.feedback),e.elements.buttonCard.addEventListener("click",(n=>{null===n.target.closest(".bubble-icon-container")&&s(e._hass,e.config.entity)}))}(e):"slider"===n?function(e){x(e.elements.iconContainer,e.config);let n=0;function t(t){t.stopPropagation();const i=t.pageX||(t.touches?t.touches[0].pageX:0);Math.abs(n-i)>10&&F(e,i,!0)}function i(n){n.stopPropagation(),e.dragging=!1;const o=n.pageX||(n.touches?n.touches[0].pageX:0);F(e,o),e.elements.buttonCardContainer.classList.remove("is-dragging"),e.elements.buttonCardContainer.removeEventListener("pointermove",t),e.elements.buttonCardContainer.removeEventListener("pointerup",i)}e.elements.rangeFill=m("div","bubble-range-fill range-fill"),e.elements.rangeSlider=m("div","bubble-range-slider range-slider"),e.elements.rangeSlider.appendChild(e.elements.rangeFill),e.elements.buttonCardContainer.appendChild(e.elements.rangeSlider),e.elements.buttonCardContainer.addEventListener("pointercancel",(function(){e.dragging=!1,e.elements.buttonCardContainer.classList.remove("is-dragging"),e.elements.buttonCardContainer.removeEventListener("pointermove",t),e.elements.buttonCardContainer.removeEventListener("pointerup",i)})),e.elements.buttonCardContainer.addEventListener("pointerdown",(o=>{e.elements.buttonCardContainer.setPointerCapture(o.pointerId),e.card.classList.contains("is-unavailable")||(e.dragging=!0,n=o.pageX||(o.touches?o.touches[0].pageX:0),e.elements.buttonCardContainer.classList.add("is-dragging"),e.elements.buttonCardContainer.addEventListener("pointermove",t),e.elements.buttonCardContainer.addEventListener("pointerup",i))}))}(e):("state"===n||"custom"===n)&&function(e){x(e.elements.buttonCardContainer,e.config),w(e.elements.buttonCard,e.elements.feedback)}(e)),function(e){"unavailable"===p(e)?e.card.classList.add("is-unavailable"):e.card.classList.remove("is-unavailable"),h(e,"light")?e.card.classList.add("is-light"):e.card.classList.remove("is-light"),b(e)?e.card.classList.add("is-on"):e.card.classList.remove("is-on")}(e),function(e){const n=H(e),t=b(e);e.elements.buttonCard.style.backgroundColor="switch"!==n&&"custom"!==n||!t?"rgba(0, 0, 0, 0)":"var(--accent-color)"}(e),function(e){const n=d(e);n!==e.elements.previousName&&(e.elements.name.innerText=n,g(e.elements.name,n),e.elements.previousName=n)}(e),function(e){const n=b(e),t=l(e),i=c(e);h(e,"light")&&n?e.elements.iconContainer.style.color=r(e):e.elements.iconContainer.style.color="",""!==i?(e.elements.image.style.backgroundImage="url("+i+")",e.elements.icon.style.display="none",e.elements.image.style.display=""):""!==t?(e.elements.icon.icon=t,e.elements.icon.style.color=n?r(e):"inherit",e.elements.icon.style.display="",e.elements.image.style.display="none"):(e.elements.icon.style.display="none",e.elements.image.style.display="none")}(e),I(e),function(e){if("slider"===H(e)){if(e.elements.rangeFill.style.backgroundColor=r(e),e.dragging)return;let n=0;if(h(e,"light"))n=100*u(e,"brightness")/255;else if(h(e,"media_player"))n=100*u(e,"volume_level");else if(h(e,"cover"))n=u(e,"current_position");else if(h(e,"input_number")){const t=u(e,"min"),i=u(e,"max");n=100*(p(e)-t)/(i-t)}e.elements.rangeFill.style.transform=`translateX(${n}%)`}}(e),function(e){const n=e.config.sub_button;if(!n)return;e.previousValues||(e.previousValues={});let t=e.previousValues.subButtons||[];for(let i=0;i<n.length;i++){let o=n[i];if(!o)continue;const a=i+1,s=o.entity??e.config.entity,r=e._hass.states[s],c=o.name??u(e,"friendly_name",s)??"",d=o.attribute??"",p=u(e,d,s),h=l(e,s,o.icon),g=b(e,s)?"var(--accent-color)":"var(--card-background-color, var(--ha-card-background))",_=o.show_name??!1,y=o.show_state??!1,v=o.show_attribute??!1,w=o.show_last_updated??!1,k=o.show_icon??!0,C=o.show_background??!0;e.elements.subButtonContainer||(e.elements.subButtonContainer=m("div","bubble-sub-button-container"),Object.assign(e.elements.subButtonContainer.style,D.subButtonContainer),e.content.firstChild.firstChild.appendChild(e.elements.subButtonContainer)),e.elements[a]||(e.elements[a]=m("div","bubble-sub-button-"+a),Object.assign(e.elements[a].style,D.subButton),e.elements[a].nameContainer=m("div","bubble-sub-button-name-container"),Object.assign(e.elements[a].nameContainer.style,D.nameContainer),e.elements[a].appendChild(e.elements[a].nameContainer),e.elements.subButtonContainer.appendChild(e.elements[a])),e.elements[a]?.nameContainer?.innerText!==e.elements[a]?.previousNameContainer&&(e.elements[a].nameContainer.innerText="",e.elements[a].previousNameContainer=e.elements[a].nameContainer.innerText),k&&h?(e.elements[a].icon||(e.elements[a].icon=m("ha-icon","bubble-sub-button-icon")),e.elements[a].icon.setAttribute("icon",h),e.elements[a].appendChild(e.elements[a].icon),e.elements[a].icon.style=D.icon,e.elements[a].icon.style.setProperty("--mdc-icon-size","16px")):!k&&e.elements[a].icon&&(e.elements[a].icon.style.display="none"),e.elements[a].style.backgroundColor=C?g:"",o.tap_action&&x(e.elements[a],o,s);const $=r&&y?e._hass.formatEntityState(r):"";let S,T,L="";function O(e){return e.charAt(0).toUpperCase()+e.slice(1)}v&&(S=r&&p?e._hass.formatEntityAttributeValue(r,d):""),w&&(T=r?f(r.last_updated,e._hass.locale.language):""),_&&c&&(L&&(L+=" - "),L+=c),$&&(L&&(L+=" - "),L+=$),T&&(L&&(L+="off"!==$.toLowerCase()?" ":" - "),L+="off"===$.toLowerCase()?O(T):T),S&&(L&&(L+=" - "),L+=S),L=O(L),""!==L||k?""===L&&k?(e.elements[a].style.display="flex",e.elements[a].icon.style.marginRight="0"):(e.elements[a].style.display="flex",e.elements[a].nameContainer.innerText=L,e.previousState=L):e.elements[a].style.display="none",L&&k&&(e.elements[a].style.display="flex",e.elements[a].icon.style.marginRight="4px")}e.previousValues.subButtons=n.slice();for(let E=t.length;E>0;E--)if(E>n.length){let B=e.elements[E];B&&(e.elements.subButtonContainer.removeChild(B),delete e.elements[E])}}(e),function(e){const n=p(e),t=e.config.styles?Function("hass","entityId","state","return `"+e.config.styles+"`;")(e._hass,e.config.entity,n):"";e.elements.customStyle.innerText=t}(e)}function j(e,n){h(e,"media_player")&&e._hass.callService("media_player","volume_set",{entity_id:e.config.entity,volume_level:n/100})}const W=_(j);function R(e,n,t=!1){const i=e.elements.rangeSlider.getBoundingClientRect(),o=100*(n-i.left)/i.width,a=Math.min(100,Math.max(0,o));e.elements.rangeFill.style.transform=`translateX(${a}%)`,t?W(e,a):j(e,a)}const Y="\n    ha-card {\n        margin-top: 0;\n        background: none;\n        opacity: 1;\n    }\n    .is-unavailable {\n        opacity: 0.5;\n    }\n\n    .bubble-media-player-container {\n        position: relative;\n        width: 100%;\n        height: 50px;\n        background-color: var(--background-color-2,var(--secondary-background-color));\n        border-radius: 25px;\n        mask-image: radial-gradient(white, black);\n        -webkit-transform: translateZ(0);\n        overflow: hidden;\n        touch-action: pan-y;\n    }\n\n    .bubble-media-player {\n        display: flex;\n        position: absolute;\n        justify-content: space-between;\n        align-items: center;\n        height: 100%;\n        width: 100%;\n        transition: background-color 1.5s;\n        background-color: rgba(0,0,0,0);\n    }\n\n    .bubble-button-container {\n        display: inline-grid;\n        grid-auto-flow: column;\n        gap: 10px;\n        align-self: center;\n        margin-right: 8px;\n    }\n\n    .bubble-play-pause-button,\n    .bubble-previous-button,\n    .bubble-next-button,\n    .bubble-volume-button,\n    .bubble-power-button {\n        background: none;\n        border: none;\n        cursor: pointer;\n        border-radius: 100%;\n        padding: 6px;\n        height: 24px;\n        width: 24px;\n        transition: background 0.3s ease;\n        align-self: center;\n    }\n\n    .bubble-play-pause-button {\n        background-color: var(--accent-color);\n    }\n\n    /*\n    .bubble-play-pause-button:hover,\n    .bubble-previous-button:hover,\n    .bubble-next-button:hover,\n    .bubble-volume-button:hover {\n        background: rgba(0, 0, 0, 0.1);\n    }\n    */\n\n    .bubble-title,\n    .bubble-artist {\n        margin: 0 10px;\n    }\n\n    .bubble-volume-slider {\n        position: absolute;\n        width: calc(100% - 150px);\n        height: 38px;\n        left: 50px;\n        overflow: hidden;\n        border-radius: 20px;\n        z-index: 1;\n        border: 2px solid var(--background-color-2, var(--secondary-background-color));\n        background-color: var(--card-background-color, var(--ha-card-background));\n        opacity: 1;\n        transition: opacity .2s, transform .2s;\n        transform: translateX(0);\n    }\n\n    .bubble-mute-button {\n        opacity: 1;\n        transition: opacity .2s, transform .2s;\n        transform: translateX(0);\n    }\n\n    .is-hidden {\n        opacity: 0 !important;\n        pointer-events: none;\n        transform: translateX(14px);\n    }\n\n    .bubble-range-fill {\n        z-index: -1;\n        position: absolute;\n        top: 0;\n        bottom: 0;\n        left: 0;\n        width: 100%;\n        left: -100%;\n        transition: all .3s;\n        background-color: var(--accent-color);\n    }\n\n    .is-dragging .bubble-range-fill {\n        transition: none;\n    }\n\n    .is-light .bubble-range-fill {\n        opacity: 0.5;\n    }\n\n    .is-unavailable .bubble-button-card {\n        cursor: not-allowed;\n    }\n\n    .bubble-range-slider {\n        cursor: ew-resize;\n    }\n    .is-unavailable .bubble-range-slider {\n        cursor: not-allowed;\n    }\n\n    .bubble-icon-container {\n        display: flex;\n        flex-wrap: wrap;\n        width: 38px;\n        height: 38px;\n        min-width: 38px;\n        min-height: 38px;\n        margin: 6px;\n        border-radius: 50%;\n        background-color: var(--card-background-color, var(--ha-card-background));\n        overflow: hidden;\n        z-index: 1;\n        position: relative;\n        cursor: pointer;\n    }\n\n    .bubble-icon {\n        opacity: 0.6;\n    }\n\n    .is-on .bubble-icon {\n      filter: brightness(1.1);\n      opacity: 1;\n    }\n\n    .bubble-icon,\n    .bubble-mute-button {\n        display: flex;\n        position: absolute;\n        height: 38px;\n        width: 38px;\n        justify-content: center;\n        align-items: center;\n    }\n\n    .bubble-entity-picture {\n        background-size: cover;\n        background-position: center;\n        height: 100%;\n        width: 100%;\n        position: absolute;\n    }\n\n    .bubble-media-info-container {\n        display: flex;\n        line-height: 1em;\n        font-size: 12px;\n        flex-direction: column;\n        justify-content: center;\n        flex-grow: 1;\n        margin-left: 4px;\n        pointer-events: none;\n        position: relative;\n        overflow: hidden;\n    }\n\n    .bubble-title,\n    .bubble-name,\n    .bubble-state,\n    .bubble-artist {\n        display: flex;\n        margin: 2px 0;\n        position: relative;\n        white-space: nowrap;\n    }\n\n    .bubble-title {\n        font-weight: 600;\n    }\n\n    /*.bubble-title span,\n    .bubble-artist span {\n        display: inline-block;\n        animation: scroll 14s linear infinite;\n    }\n\n    .bubble-scroll-separator {\n        opacity: .3; \n        margin: 0 6px 0 8px;\n    }\n\n    @keyframes scroll {\n        from { transform: translateX(0%); }\n        to { transform: translateX(-50%); }\n    }*/\n\n    .bubble-name-container {\n        display: flex;\n        line-height: 1em;\n        flex-direction: column;\n        justify-content: center;\n        flex-grow: 1;\n        font-weight: 600;\n        margin-left: 4px;\n        /*margin-right: 16px;*/\n        pointer-events: none;\n        position: relative;\n        overflow: hidden;\n    }\n\n    .bubble-name {\n        margin: 2px 0;\n    }\n\n    .bubble-state {\n        font-size: 12px;\n        opacity: 0.7;\n        margin: 2px 0;\n        font-weight: normal;\n    }\n\n    @media screen and (max-width: 250px) {\n        .bubble-previous-button {\n            display: none;\n        }\n    }\n\n    @media screen and (max-width: 206px) {\n        .bubble-next-button {\n            display: none;\n        }\n    }\n\n    @media screen and (max-width: 160px) {\n        .bubble-volume-button {\n            display: none;\n        }\n    }\n\n    @keyframes tap-feedback {\n        0% {transform: translateX(-100%); opacity: 0;}\n        64% {transform: translateX(0); opacity: 0.1;}\n        100% {transform: translateX(100%); opacity: 0;}\n    }\n";function q(e){"media-player"!==e.cardType&&function(e){e.dragging=!1,e.elements={},e.elements.mediaPlayerContainer=m("div","bubble-media-player-container"),e.elements.mediaPlayerCard=m("div","bubble-media-player"),e.elements.mediaInfoContainer=m("div","bubble-media-info-container"),e.elements.nameContainer=m("div","bubble-name-container"),e.elements.buttonContainer=m("div","bubble-button-container"),e.elements.iconContainer=m("div","bubble-icon-container"),e.elements.playPauseButton=m("ha-icon","bubble-play-pause-button"),e.elements.previousButton=m("ha-icon","bubble-previous-button"),e.elements.previousButton.setAttribute("icon","mdi:skip-previous"),e.elements.nextButton=m("ha-icon","bubble-next-button"),e.elements.nextButton.setAttribute("icon","mdi:skip-next"),e.elements.volumeButton=m("ha-icon","bubble-volume-button"),e.elements.volumeButton.setAttribute("icon","mdi:volume-high"),e.elements.powerButton=m("ha-icon","bubble-power-button"),e.elements.powerButton.setAttribute("icon","mdi:power-standby"),e.elements.muteButton=m("ha-icon","bubble-mute-button is-hidden"),e.elements.muteButton.setAttribute("icon","mdi:volume-off"),e.elements.title=m("div","bubble-title"),e.elements.artist=m("div","bubble-artist"),e.elements.name=m("div","bubble-name"),e.elements.state=m("div","bubble-state"),e.elements.icon=m("ha-icon","bubble-icon"),e.elements.image=m("div","bubble-entity-picture"),e.elements.style=m("style"),e.elements.customStyle=m("style"),e.elements.style.innerText=Y,e.elements.iconContainer.appendChild(e.elements.icon),e.elements.iconContainer.appendChild(e.elements.image),e.elements.iconContainer.appendChild(e.elements.muteButton),e.elements.nameContainer.appendChild(e.elements.name),e.elements.nameContainer.appendChild(e.elements.state),e.elements.mediaInfoContainer.appendChild(e.elements.title),e.elements.mediaInfoContainer.appendChild(e.elements.artist),e.config.hide?.power_button||e.elements.buttonContainer.appendChild(e.elements.powerButton),e.config.hide?.previous_button||e.elements.buttonContainer.appendChild(e.elements.previousButton),e.config.hide?.next_button||e.elements.buttonContainer.appendChild(e.elements.nextButton),e.config.hide?.volume_button||e.elements.buttonContainer.appendChild(e.elements.volumeButton),e.config.hide?.play_pause_button||e.elements.buttonContainer.appendChild(e.elements.playPauseButton),e.elements.mediaPlayerCard.appendChild(e.elements.iconContainer),e.elements.mediaPlayerCard.appendChild(e.elements.mediaInfoContainer),e.elements.mediaPlayerCard.appendChild(e.elements.nameContainer),e.elements.mediaPlayerCard.appendChild(e.elements.buttonContainer),e.content.innerHTML="",e.content.appendChild(e.elements.mediaPlayerContainer),e.content.appendChild(e.elements.style),e.content.appendChild(e.elements.customStyle),e.elements.mediaPlayerContainer.appendChild(e.elements.mediaPlayerCard),x(e.elements.icon,e.config),x(e.elements.image,e.config),e.elements.volumeSliderContainer=m("div","bubble-volume-slider is-hidden"),function(e,n){let t=0;function i(n){n.stopPropagation();const i=n.pageX||(n.touches?n.touches[0].pageX:0);Math.abs(t-i)>10&&R(e,i,!0)}function o(t){t.stopPropagation(),e.dragging=!1;const a=t.pageX||(t.touches?t.touches[0].pageX:0);R(e,a),n.classList.remove("is-dragging"),n.removeEventListener("pointermove",i),n.removeEventListener("pointerup",o)}e.elements.rangeFill=m("div","bubble-range-fill range-fill"),e.elements.rangeSlider=m("div","bubble-range-slider range-slider"),e.elements.rangeSlider.appendChild(e.elements.rangeFill),n.appendChild(e.elements.rangeSlider),n.addEventListener("pointercancel",(function(){e.dragging=!1,n.classList.remove("is-dragging"),n.removeEventListener("pointermove",i),n.removeEventListener("pointerup",o)})),n.addEventListener("pointerdown",(a=>{n.setPointerCapture(a.pointerId),e.card.classList.contains("is-unavailable")||(e.dragging=!0,t=a.pageX||(a.touches?a.touches[0].pageX:0),n.classList.add("is-dragging"),n.addEventListener("pointermove",i),n.addEventListener("pointerup",o))}))}(e,e.elements.volumeSliderContainer),e.elements.mediaPlayerCard.appendChild(e.elements.volumeSliderContainer),e.elements.volumeButton.addEventListener("click",(()=>{e.elements.volumeSliderContainer.classList.toggle("is-hidden"),e.elements.muteButton.classList.toggle("is-hidden"),e.elements.icon.classList.toggle("is-hidden"),e.elements.image.classList.toggle("is-hidden"),function(e){e.elements.volumeButton.isHidden?(e.elements.volumeButton.setAttribute("icon","mdi:volume-high"),e.elements.volumeButton.isHidden=!1):(e.elements.volumeButton.setAttribute("icon","mdi:close"),e.elements.volumeButton.isHidden=!0)}(e)})),e.elements.powerButton.addEventListener("click",(()=>{const n=b(e);e._hass.callService("media_player",n?"turn_off":"turn_on",{entity_id:e.config.entity})})),e.elements.muteButton.addEventListener("click",(()=>{const n=!0===u(e,"is_volume_muted");e._hass.callService("media_player","volume_mute",{entity_id:e.config.entity,is_volume_muted:!n}),e.elements.muteButton.clicked=!0})),e.elements.previousButton.addEventListener("click",(()=>{e._hass.callService("media_player","media_previous_track",{entity_id:e.config.entity})})),e.elements.nextButton.addEventListener("click",(()=>{e._hass.callService("media_player","media_next_track",{entity_id:e.config.entity})})),e.elements.playPauseButton.addEventListener("click",(()=>{e._hass.callService("media_player","media_play_pause",{entity_id:e.config.entity}),e.elements.playPauseButton.clicked=!0})),e.cardType="media-player"}(e),function(e){"unavailable"===p(e)?e.card.classList.add("is-unavailable"):e.card.classList.remove("is-unavailable"),b(e)?e.card.classList.add("is-on"):e.card.classList.remove("is-on")}(e),function(e){const n=d(e);n!==e.previousName&&(e.elements.name.innerText=n,e.previousName=n,g(e.elements.name,n))}(e),function(e){const n=u(e,"media_title"),t=u(e,"media_artist"),i=n+t;i!==e.previousState&&(e.elements.artist.style.display=""===t?"none":"flex",g(e.elements.title,n),g(e.elements.artist,t),e.previousState=i)}(e),function(e){u(e,"media_title");const n=""===u(e,"media_artist");e.elements.mediaInfoContainer.style.display=n?"none":"",e.elements.nameContainer.style.display=n?"":"none"}(e),function(e){const n=b(e),t=l(e),i=c(e);""!==i?(e.elements.image.style.backgroundImage="url("+i+")",e.elements.icon.style.display="none",e.elements.image.style.display=""):""!==t?(e.elements.icon.icon=t,e.elements.icon.style.color=n?"var(--accent-color)":"inherit",e.elements.icon.style.display="",e.elements.image.style.display="none"):(e.elements.icon.style.display="none",e.elements.image.style.display="none")}(e),I(e),function(e){if(h(e,"media_player")&&!1===e.dragging&&e.elements.rangeFill){const n=100*u(e,"volume_level");e.elements.rangeFill.style.transform=`translateX(${n}%)`}}(e),function(e){const n="playing"===p(e),t=e.elements.playPauseButton.clicked;n?e.elements.playPauseButton.setAttribute("icon",t?"mdi:play":"mdi:pause"):e.elements.playPauseButton.setAttribute("icon",t?"mdi:pause":"mdi:play"),e.elements.playPauseButton.clicked=!1}(e),function(e){const n=!0===u(e,"is_volume_muted"),t=e.elements.muteButton.clicked;e.elements.muteButton.style.color=n?t?"":"var(--accent-color)":t?"var(--accent-color)":"",e.elements.muteButton.clicked=!1}(e),function(e){const n=b(e);e.elements.powerButton.style.color=n?"var(--accent-color)":""}(e),function(e){const n=p(e),t=e.config.styles?Function("hass","entityId","state","return `"+e.config.styles+"`;")(e._hass,e.config.entity,n):"";e.elements.customStyle.innerText=t}(e)}customElements.get("ha-switch");const G=Object.getPrototypeOf(customElements.get("ha-panel-lovelace")),Z=G.prototype.html,J=G.prototype.css;customElements.define("bubble-card-editor",class extends G{setConfig(e){this._config={...e}}static get properties(){return{hass:{},_config:{}}}get _card_type(){return this._config.card_type||""}get _button_type(){return this._config.button_type||"switch"}get _entity(){return this._config.entity||""}get _name(){return this._config.name||""}get _icon(){return this._config.icon||""}get _state(){return this._config.state||""}get _text(){return this._config.text||""}get _hash(){return this._config.hash||"#pop-up-name"}get _trigger_entity(){return this._config.trigger_entity||""}get _trigger_state(){return this._config.trigger_state||""}get _trigger_close(){return this._config.trigger_close||!1}get _margin(){return this._config.margin||"7px"}get _margin_top_mobile(){return this._config.margin_top_mobile||"0px"}get _margin_top_desktop(){return this._config.margin_top_desktop||"0px"}get _width_desktop(){return this._config.width_desktop||"540px"}get _bg_color(){return this._config.bg_color||window.color}get _bg_opacity(){return void 0!==this._config.bg_opacity?this._config.bg_opacity:"88"}get _bg_blur(){return void 0!==this._config.bg_blur?this._config.bg_blur:"14"}get _shadow_opacity(){return void 0!==this._config.shadow_opacity?this._config.shadow_opacity:"0"}get _is_sidebar_hidden(){return this._config.is_sidebar_hidden||!1}get _rise_animation(){return void 0===this._config.rise_animation||this._config.rise_animation}get _auto_close(){return this._config.auto_close||""}get _close_on_click(){return this._config.close_on_click||!1}get _background_update(){return this._config.background_update||!1}get _icon_open(){return this._config.icon_open||""}get _icon_close(){return this._config.icon_close||""}get _open_service(){return this._config.open_service||"cover.open_cover"}get _close_service(){return this._config.open_service||"cover.close_cover"}get _stop_service(){return this._config.open_service||"cover.stop_cover"}get _auto_order(){return this._config.auto_order||!1}get _highlight_current_view(){return this._config.highlight_current_view||!1}get _show_state(){const e="state"===this._config.card_type;return this._config.show_state||e}get _show_attribute(){const e="state"===this._config.card_type;return this._config.show_attribute||e}get _show_last_updated(){const e="state"===this._config.card_type;return this._config.show_last_updated||e}get _attribute(){return this._config.attribute||!1}get _hide_backdrop(){return this._config.hide_backdrop||!1}get _hide_gradient(){return this._config.hide_gradient||!1}get _hide_play_pause_button(){return this._config.hide?.play_pause_button||!1}get _hide_next_button(){return this._config.hide?.next_button||!1}get _hide_previous_button(){return this._config.hide?.previous_button||!1}get _hide_volume_button(){return this._config.hide?.volume_button||!1}get _hide_power_button(){return this._config.hide?.power_button||!1}get _sub_button(){return this._config.sub_button||""}get _tap_action(){return{action:this._config.tap_action?.action||"more-info",navigation_path:this._config.tap_action?.navigation_path||"",url_path:this._config.tap_action?.url_path||"",service:this._config.tap_action?.service||"",target_entity:this._config.tap_action?.target?.entity_id||"",data:this._config.tap_action?.data||""}}get _double_tap_action(){return{action:this._config.double_tap_action?.action||"toggle",navigation_path:this._config.double_tap_action?.navigation_path||"",url_path:this._config.double_tap_action?.url_path||"",service:this._config.double_tap_action?.service||"",target_entity:this._config.double_tap_action?.target?.entity_id||"",data:this._config.double_tap_action?.data||""}}get _hold_action(){return{action:this._config.hold_action?.action||"toggle",navigation_path:this._config.hold_action?.navigation_path||"",url_path:this._config.hold_action?.url_path||"",service:this._config.hold_action?.service||"",target_entity:this._config.hold_action?.target?.entity_id||"",data:this._config.hold_action?.data||""}}render(){if(!this.hass)return Z``;const e=document.querySelector("body > home-assistant").shadowRoot.querySelector("hui-dialog-edit-card").shadowRoot.querySelector("ha-dialog > div.content > div.element-preview");if("sticky"!==e.style.position&&(e.style.position="sticky",e.style.top="0"),!this.listsUpdated){const s=e=>({label:e,value:e});this.allEntitiesList=Object.keys(this.hass.states).map(s),this.lightList=Object.keys(this.hass.states).filter((e=>"light"===e.substr(0,e.indexOf(".")))).map(s),this.sensorList=Object.keys(this.hass.states).filter((e=>"sensor"===e.substr(0,e.indexOf(".")))).map(s),this.binarySensorList=Object.keys(this.hass.states).filter((e=>"binary_sensor"===e.substr(0,e.indexOf(".")))).map(s),this.coverList=Object.keys(this.hass.states).filter((e=>"cover"===e.substr(0,e.indexOf(".")))).map(s),this.mediaPlayerList=Object.keys(this.hass.states).filter((e=>"media_player"===e.substr(0,e.indexOf(".")))).map(s),this.attributeList=Object.keys(this.hass.states[this._entity]?.attributes||{}).map((e=>{let n=this.hass.states[this._entity];return{label:this.hass.formatEntityAttributeName(n,e),value:e}})),this.cardTypeList=[{label:"Button (Switch, slider or state)",value:"button"},{label:"Cover",value:"cover"},{label:"Empty column",value:"empty-column"},{label:"Horizontal buttons stack",value:"horizontal-buttons-stack"},{label:"Media player",value:"media-player"},{label:"Pop-up",value:"pop-up"},{label:"Separator",value:"separator"}],this.buttonTypeList=[{label:"Switch",value:"switch"},{label:"Slider",value:"slider"},{label:"State",value:"state"}],this.tapActionTypeList=[{label:"More info",value:"more-info"},{label:"Toggle",value:"toggle"},{label:"Navigate",value:"navigate"},{label:"URL",value:"url"},{label:"Call service",value:"call-service"},{label:"No action",value:"none"}],this.listsUpdated=!0}const t=this.allEntitiesList,i=(this.lightList,this.sensorList,this.coverList),o=this.cardTypeList,a=this.buttonTypeList;if("pop-up"===this._config.card_type)return Z`
            ...
            `;if("horizontal-buttons-stack"===this._config.card_type){if(!this.buttonAdded)for(this.buttonAdded=!0,this.buttonIndex=0;this._config[this.buttonIndex+1+"_link"];)this.buttonIndex++;function l(){this.buttonIndex++,this.requestUpdate()}return Z`
                <div class="card-config">
                    ${this.makeDropdown("Card type","card_type",o)}
            ...
            `}makeShowState(e=this._config,n="",t=!1){const i=e?.entity??this._config.entity??"",o=e===this._config,a=Object.keys(this.hass.states[i]?.attributes||{}).map((e=>{let n=this.hass.states[i];return{label:this.hass.formatEntityAttributeName(n,e),value:e}}));return Z`
            ${t?Z`
            ...
            `:""}
        `}makeDropdown(e,n,t){return e.includes("icon")||e.includes("Icon")?Z`
          ...
          `}makeTapActionPanel(e,n,t=this._config,i=""){this.hass;const o="Tap action"===e?"mdi:gesture-tap":"Double tap action"===e?"mdi:gesture-double-tap":"mdi:gesture-tap-hold",a="Tap action"===e?t.tap_action||this._tap_action:"Double tap action"===e?t.double_tap_action||this._double_tap_action:t.hold_action||this._hold_action,s="Tap action"===e?"tap_action":"Double tap action"===e?"double_tap_action":"hold_action",l=t===this._config,r=l&&"Tap action"===e?"more-info":l?"toggle":"";return Z`
            <ha-expansion-panel outlined>
                ...
                <div class="content"> 
                    ...
                    `:""}
                    ${"call-service"===a?.action&&a?.service?Z`
        ...
        `}makeSubButtonPanel(){const e=this._config?.sub_button?.map(((e,n)=>{if(!e)return;const t="sub_button."+n+".";return Z`
            <ha-expansion-panel outlined>
                <h4 slot="header">
                    <ha-icon icon="mdi:border-radius"></ha-icon>
                    ${this._config.sub_button[n]?"Button "+(n+1)+(e.name?" - "+e.name:""):"New button"}
                    <button class="icon-button header" @click="${()=>{this._config.sub_button.splice(n,1),this._valueChanged({target:{configValue:"sub_button."+(n-1),value:e}}),this.requestUpdate()}}">
                      <ha-icon icon="mdi:delete"></ha-icon>
                    </button>
                    ${n>0?Z`<button class="icon-button header" @click="${e=>{e.stopPropagation(),n>0&&([this._config.sub_button[n],this._config.sub_button[n-1]]=[this._config.sub_button[n-1],this._config.sub_button[n]],this._valueChanged({target:{configValue:"sub_button."+n,value:this._config.sub_button[n]}})),this.requestUpdate()}}">
                      <ha-icon icon="mdi:arrow-left"></ha-icon>
                    </button>`:""}
                    ${n<this._config.sub_button.length-1?Z`<button class="icon-button header" @click="${e=>{e.stopPropagation(),n<this._config.sub_button.length-1&&([this._config.sub_button[n],this._config.sub_button[n+1]]=[this._config.sub_button[n+1],this._config.sub_button[n]],this._valueChanged({target:{configValue:"sub_button."+n,value:this._config.sub_button[n]}})),this.requestUpdate()}}">
      ...
      `}makeButton(){let e=[];for(let n=1;n<=this.buttonIndex;n++)e.push(Z`
                <div class="${n}_button">
                    <ha-expansion-panel outlined>
